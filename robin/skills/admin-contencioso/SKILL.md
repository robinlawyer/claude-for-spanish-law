---
name: admin-contencioso
description: >
  Recurso contencioso-administrativo ante Juzgados, TSJ, AN o TS (LJCA).
  Procedimiento ordinario o abreviado.
argument-hint: "[acto recurrido + cuantía + órgano competente]"
---

# /robin:admin-contencioso

Pipeline:

1. **Competencia**:
   - Juzgados CA: actos administrativos locales y autonómicos hasta
     cuantía determinada.
   - TSJ: actos autonómicos y CCAA.
   - AN: actos estatales (Ministerios, organismos).
   - TS: en casación o recursos directos contra disposiciones del
     Gobierno.

2. **Plazo**: 2 meses (acto expreso) / 6 meses (silencio).
   `/robin:plazos`.

3. **`mcp__robin__preparar_recurso_administrativo`** con
   tipo=contencioso.

4. **Procedimiento**: ordinario (mayor cuantía / personal) /
   abreviado (cuantía hasta 30.000 € + personal + sanción
   pecuniaria hasta 60.000 €).

5. **Suspensión cautelar** (arts. 129-136 LJCA) si procede.

6. **Costas**: art. 139 LJCA — al perdedor salvo seria duda.

7. **Doctrina Sala 3ª TS** y TSJ del territorio.

8. **Verifica citas**.

## Avisos típicos

- Procedimiento abreviado: vista oral + sentencia rápida.
- Inactividad administrativa: art. 29 LJCA, recurso especial.
- Recurso directo contra disposición general: 2 meses desde
  publicación.
