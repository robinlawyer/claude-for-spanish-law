---
name: admin-medidas-cautelares
description: >
  Medidas cautelares en vía contencioso-administrativa: suspensión del acto,
  cautelares positivas (arts. 129-136 LJCA).
argument-hint: "[acto recurrido + perjuicio + ponderación de intereses]"
---

# /robin:admin-medidas-cautelares

Pipeline:

1. **Periculum in mora**: perjuicios irreparables o de difícil
   reparación.

2. **Ponderación de intereses**: si la suspensión causa perturbación
   grave al interés general, deniega.

3. **`mcp__robin__preparar_acto_pre_procesal`** con
   tipo=medida_cautelar_administrativa.

4. **Caución** si procede (art. 133 LJCA).

5. **Tramitación**: pieza separada, audiencia 5 días, auto.

6. **Recurso contra el auto**: reposición / apelación / casación
   según órgano.
...
- Suspensión inaudita parte sólo en supuestos de extraordinaria
  urgencia (art. 135 LJCA).
- Doctrina TS sobre ponderación: si "fumus boni iuris" es claro
  (vulneración patente de norma), suele inclinarse la balanza.
