---
name: admin-recurso-alzada
description: >
  Recurso de alzada ante el superior jerárquico (Ley 39/2015 arts. 121-122).
  Obligatorio agotar vía si la norma lo prevé.
argument-hint: "[acto recurrido + órgano superior + motivos]"
---

# /robin:admin-recurso-alzada

Pipeline:

1. **Verifica**: acto no agota vía administrativa.

2. **Plazo**: 1 mes (acto expreso) / 3 meses (silencio).

3. **`mcp__robin__preparar_recurso_administrativo`** con tipo=alzada.

4. **Tramitación**: ante órgano emisor o ante el superior. Si ante
   el emisor, este lo eleva con su informe.

5. **Silencio**: regla general desestimatorio (art. 24.1 Ley 39/2015,
   con excepciones legales). Calcular fecha.

6. **Pieza separada de suspensión** si procede.

7. **Verifica citas**.

## Avisos típicos

- Si la norma especial dice "agota la vía administrativa" sin
  alzada: directamente contencioso.
- Doctrina Consejo de Estado relevante si afecta a sectores
  consultivos.
