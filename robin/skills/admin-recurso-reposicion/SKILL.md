---
name: admin-recurso-reposicion
description: >
  Recurso potestativo de reposición ante el órgano que dictó el acto (Ley
  39/2015 arts. 123-124). Alternativo al contencioso directo.
argument-hint: "[acto recurrido + motivos + órgano emisor]"
---

# /robin:admin-recurso-reposicion

Pipeline:

1. **Verifica idoneidad**. Acto definitivo o de trámite cualificado.
   Vía administrativa NO agotada (si está agotada → contencioso
   directo).

2. **Plazo**: 1 mes (acto expreso) o 3 meses (silencio).
   `/robin:plazos`.

3. **`mcp__robin__preparar_recurso_administrativo`** con
   tipo=reposicion.

4. **Motivos**: cualquier infracción del ordenamiento.

5. **Pieza separada de suspensión** si procede (art. 117 Ley 39/2015):
   acto causa perjuicios irreparables o existe nulidad de pleno
   derecho.

6. **Si silencio**: efectos según norma específica (positivo /
   negativo / falta de respuesta).
