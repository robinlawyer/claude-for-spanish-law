---
name: admin-responsabilidad-patrimonial
description: >
  Reclamación de responsabilidad patrimonial de la Administración (art. 32
  Ley 40/2015). Daño antijurídico, nexo causal, lex artis ad hoc.
argument-hint: "[daño + actuación administrativa + nexo causal]"
---
...
1. **Verificar requisitos** (art. 32 Ley 40/2015):
   - Daño efectivo, evaluable económicamente, individualizado.
   - Antijuridicidad (el particular no tiene el deber jurídico de
     soportarlo).
   - Nexo causal con funcionamiento de servicio público.
   - No fuerza mayor.

2. **Plazo**: 1 año desde el hecho o desde su manifestación.

3. **`mcp__robin__preparar_reclamacion_civil`** con tipo=responsabilidad_patrimonial.

4. **Cuantificación del daño**: facturas, periciales, baremos
   orientativos (tráfico si lesiones).

5. **Vía**:
   - Reclamación previa administrativa.
   - Si silencio o desestimación: contencioso (LJCA).

6. **Doctrina TS Sala 3ª**.

7. **Verifica citas**.

## Avisos típicos

- Responsabilidad sanitaria: lex artis ad hoc. Pericial médica
  imprescindible.
- Responsabilidad por leyes inconstitucionales: criterios STS
  específicos.
- Si daño en relación contractual administrativa: cauce distinto.
