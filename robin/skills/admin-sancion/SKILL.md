...
name: admin-sancion
description: >
  Defensa frente a procedimiento sancionador administrativo (Ley 39/2015 +
  norma sectorial: SAEPD, ITSS, Tráfico, CNMC, CNMV, etc.).
argument-hint: "[infracción imputada + Administración + cuantía]"
---
...
1. **Norma sectorial**: identificar (RGPD-AEPD, ITSS-LISOS, Tráfico-
   LTSV, sanciones CNMC/CNMV/BdE, locales, etc.). Cada una con sus
   especialidades procedimentales.

2. **Alegaciones en trámite** (15 días desde notificación de la
   propuesta).

3. **`mcp__robin__preparar_escrito_libre`** con tipo=alegaciones_sancion.

4. **Líneas de defensa**:
   - Prescripción de la infracción / sanción.
   - Tipicidad (no concurre el tipo).
   - Ausencia de culpabilidad.
   - Proporcionalidad de la sanción.
   - Defectos formales del procedimiento.
   - Ne bis in idem.

5. **Doctrina del órgano sancionador**: AEPD, ITSS, CNMC, etc.
   (búsquedas específicas).

6. **Si resolución sancionadora final**: recurso administrativo y/o
   contencioso. Pieza cautelar de suspensión.

7. **Verifica citas**.

## Avisos típicos

- Ley 40/2015 art. 28: principio de tipicidad estricto.
- Principio non bis in idem entre administrativo y penal: si hay
  proceso penal pendiente, suspensión del administrativo.
- Reducción por reconocimiento + pronto pago: posible.
