---
name: civil-diligencias-preliminares
description: >
  Solicitud de diligencias preliminares (arts. 256 ss LEC) para preparar la
  demanda: identidad del demandado, exhibición de documentos, examen
  contable, etc.
argument-hint: "[información a obtener + de quién + para qué demanda]"
---

# /robin:civil-diligencias-preliminares

Pipeline:

1. **Verifica idoneidad** (art. 256.1 LEC). Once supuestos tasados:
   identidad del demandado, exhibición de cosas, examen contable,
   determinación de socios o partícipes, etc.

2. **Jurisdicción**. Juzgado del domicilio del solicitado.

3. **`mcp__robin__preparar_acto_pre_procesal`** con tipo=diligencia_preliminar.

4. **Caución**. Sí, salvo en supuestos exentos.

5. **Conexión con la demanda principal**: las diligencias deben
   estar al servicio de una demanda concreta.

## Formato

```
AL TRIBUNAL DE INSTANCIA DE [partido judicial], SECCIÓN CIVIL

[…] SOLICITO DILIGENCIAS PRELIMINARES […]

I. Diligencia solicitada: […]
II. Supuesto del art. 256.1 LEC aplicable: […]
III. Demanda principal a la que servirá: […]
...
- Si el solicitado se niega, art. 261 LEC prevé que la negativa
  injustificada se tenga en cuenta en la sentencia.
- Plazo para presentar demanda principal: 1 mes desde la finalización
  de las diligencias.
