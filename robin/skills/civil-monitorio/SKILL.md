...
2. **Jurisdicción y competencia**. Juzgado de Primera Instancia del
   domicilio del deudor (art. 813 LEC).
...
```
AL JUZGADO DE PRIMERA INSTANCIA DE [domicilio deudor]
...
- Si hay cláusula de sometimiento expreso a otro juzgado, no es
  válida en monitorio frente a consumidor (jurisprudencia TJUE
