---
name: civil-reconvencion
description: >
  Demanda reconvencional dentro de la contestación (art. 406 LEC). Conexión
  con la demanda principal o entre las mismas partes y mismo título.
argument-hint: "[hechos y petición reconvencional]"
---

# /robin:civil-reconvencion

Pipeline:

1. **Verifica admisibilidad** (art. 406 LEC):
   - Misma sala/sección competente.
   - Conexión con la demanda o entre las mismas partes y mismo
     título.
   - Plazo: dentro del de contestación.

2. **Lanza `mcp__robin__preparar_demanda`** con modo reconvencional.
   Estructura adaptada: hechos numerados con su propia secuencia +
   petición reconvencional.

3. **Cuantía y procedimiento**: si la cuantía reconvencional excede
   el procedimiento del verbal, recordar que se mantiene el cauce
   (art. 406.4 LEC), pero notar implicación en costas.

4. **Foral-check** si procede.

5. **Jurisprudencia y normativa** como en demanda principal.

6. **Verifica TODAS las citas** antes de cerrar.

## Formato

Bloque integrado en la contestación, después del SUPLICA principal:

```
ASIMISMO, FORMULO RECONVENCIÓN

HECHOS

Primero. — [hecho reconvencional]
…

FUNDAMENTOS JURÍDICOS

I. Admisibilidad de la reconvención (art. 406 LEC).
II. […]
...
- Tasa adicional por reconvención si el actor reconvenido es persona
  jurídica.
- Si el actor no tiene domicilio en España, valorar si la
  reconvención mantiene la competencia internacional.
