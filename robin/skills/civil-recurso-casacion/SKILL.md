---
name: civil-recurso-casacion
description: >
  Recurso de casación civil ante el TS (Sala 1ª). Interés casacional, motivos
  tasados, jurisprudencia consolidada del TS.
argument-hint: "[sentencia de AP recurrida + interés casacional invocado]"
---

# /robin:civil-recurso-casacion

Pipeline:

1. **Verifica admisibilidad** (arts. 477 ss LEC):
   - Cuantía superior a 3.000.000 € (no aplica si tutela derechos
     fundamentales o procesos sin cuantía).
   - **O** interés casacional acreditado:
     a) oposición a doctrina del TS;
     b) jurisprudencia contradictoria de AAPP;
     c) aplicación de norma con menos de 5 años de vigencia sin
        jurisprudencia consolidada.

2. **Plazo**. `/robin:plazos` — 20 días hábiles desde notificación.

3. **Depósito**. `mcp__robin__deposito_recurso` (50 € casación civil).

4. **Foral-check** si materia civil foral.

5. **Identificar motivos exactos** (cerrada lista, art. 477.2 LEC):
   infracción de norma sustantiva aplicable, infracción de
   jurisprudencia del TS, infracción de derechos fundamentales si
   afectan a la decisión.

6. **`mcp__robin__preparar_recurso_extraordinario`** con tipo=casacion_civil.

7. **Jurisprudencia consolidada del TS**. `/robin:jurisprudencia
   --organo TS` con la norma cuya infracción se denuncia. Acreditar
   doctrina consolidada (al menos 2-3 STS coincidentes).

8. **Si interés casacional por contradicción entre AAPP**: cita
   ambas líneas con ECLI.

9. **Verifica TODAS las citas**.

## Formato

Estructura art. 481 LEC:
...
INTERPONGO RECURSO DE CASACIÓN contra la Sentencia nº [N] de la
Sección [N] de la Audiencia Provincial de [territorio] de [fecha].

INTERÉS CASACIONAL

[Justificación detallada conforme art. 477.3 LEC]

MOTIVOS

Único motivo (o numerados). — Infracción del art. [N] [norma], por
indebida aplicación / inaplicación, en contra de la doctrina del
Tribunal Supremo establecida en SSTS […].
...
- Casación es admisión muy restrictiva. Robin recuerda al letrado
  que la mayoría de los recursos se inadmiten en fase de
  admisibilidad.
- Si la causa es interés casacional novedoso, vincular con doctrina
  internacional (TJUE/TEDH) si encaja.
- Acuerdo no jurisdiccional del Pleno TS: si hay uno aplicable
  post LO 1/2025, citarlo (provisionalmente vía
  `mcp__robin__buscar_jurisprudencia` con query incluyendo "acuerdo no
  jurisdiccional Pleno"; la tool dedicada está pendiente en backend).
