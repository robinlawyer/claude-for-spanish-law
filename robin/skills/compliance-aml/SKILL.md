...
name: compliance-aml
description: >
  Compliance en prevención de blanqueo de capitales y financiación del
  terrorismo (Ley 10/2010 + Reglamento RD 304/2014). Identificación de
  riesgos, KYC, SEPBLAC.
argument-hint: "[sujeto obligado + actividad + tamaño]"
---

# /robin:compliance-aml

Pipeline:

1. **¿Es sujeto obligado?** Ley 10/2010 art. 2: entidades de
   crédito, seguros, abogados (en operaciones específicas),
   notarios, registradores, gestores administrativos, fiscales,
   inmobiliarias, joyeros, casinos, criptoactivos, etc.

2. **`mcp__robin__auditar_compliance_aml`** con tipo de sujeto +
   actividad.

3. **Obligaciones**:
   - Identificación formal y conocimiento del cliente (KYC).
   - Identificación del titular real.
   - Análisis de riesgo: examen especial.
   - Comunicación al SEPBLAC de operaciones sospechosas.
   - Conservación de documentos (10 años).
   - Procedimientos internos + manual.
   - Formación.
   - Auditoría externa periódica (empresas obligadas).

4. **Para abogados (operaciones del art. 2.1.ñ)**: compraventa de
   inmuebles, gestión de fondos, sociedades, etc. NO en defensa
   judicial.

5. **Sanciones**: muy elevadas (Ley 10/2010 art. 56-59).

6. **Verifica citas**.

## Avisos típicos

- Confidencialidad abogado-cliente: subsiste salvo deber de
  comunicación al SEPBLAC en operaciones expresamente cubiertas.
- Criptoactivos: regulación reforzada con MiCA (Reglamento UE
  2023/1114) + Reglamento UE 2024/1624 (AMLR).
