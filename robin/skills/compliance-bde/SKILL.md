...
name: compliance-bde
description: >
  Cumplimiento bancario y entidades de pago (LOSS + Reglamentos UE).
  Supervisión BdE, circulares, sanciones.
argument-hint: "[asunto + entidad]"
---

# /robin:compliance-bde

Pipeline:

1. **Tipo de cuestión**:
   - Solvencia y supervisión.
   - Información al cliente bancario.
   - Cláusulas suelo, IRPH, gastos hipotecarios (doctrina TJUE
     consolidada).
   - Pagos: SEPA, PSD2, instant payments.
   - Servicios de pago (Ley 7/2024).

2. **`mcp__robin__buscar_bde`**. Circulares y resoluciones
   sancionadoras.

3. **Cooperación con SEPBLAC** y otras autoridades.

4. **Doctrina BdE + Sala 3ª AN/TS** + TJUE.

5. **Verifica citas**.

## Avisos típicos

- Reclamaciones de consumidores: vía DGSFP / Servicio Reclamaciones
  BdE → MIP → judicial.
- Cláusulas abusivas en hipoteca: control de oficio + restitución
  íntegra (TJUE *Gutiérrez Naranjo*).
