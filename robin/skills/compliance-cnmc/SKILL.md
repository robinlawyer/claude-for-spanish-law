---
name: compliance-cnmc
description: >
  Cumplimiento sectorial CNMC: competencia (LDC + TFUE 101-102), telecos,
  energía, postal, transporte. Concentraciones, conductas, sanciones.
argument-hint: "[asunto + sector + empresa]"
---

# /robin:compliance-cnmc

Pipeline:

1. **Tipo de cuestión**:
   - Competencia: cártel, abuso posición dominante, restricciones
     verticales.
   - Concentración: notificación previa (umbrales art. 8 LDC).
   - Sectorial: telecos, energía, postal, transporte.

2. **`mcp__robin__buscar_cnmc`** sobre el asunto. Doctrina CNMC
   abundantísima por sector.

3. **`mcp__robin__auditar_compliance_*`** según necesidad.

4. **Programa de cumplimiento de competencia**: mitigación
   sancionatoria potencial.

5. **Procedimiento sancionador CNMC**:
   - Pliego de cargos.
   - Alegaciones.
   - Resolución.
   - Recurso contencioso ante AN.

6. **Clemencia** (LDC art. 65): para denunciantes de cárteles.

7. **Doctrina CNMC + Sala 3ª AN/TS**.

8. **Verifica citas**.

## Avisos típicos

- Clemencia: solo primer denunciante de un cártel obtiene plena
  exención. Carrera por ser primero.
- Concentración con dimensión UE: notificación a CE, no a CNMC.
