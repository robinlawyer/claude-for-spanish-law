---
name: compliance-cnmv
description: >
  Cumplimiento mercados de valores (LMV + Reglamento UE MiFID II + MAR +
  Prospect Regulation). Información, abuso de mercado, OPAs, gestión de
  fondos.
argument-hint: "[cuestión + entidad + situación]"
---

# /robin:compliance-cnmv

Pipeline:

1. **Tipo de cuestión**:
   - Información privilegiada y abuso de mercado (MAR + arts. 282
     ss CP).
   - Información relevante / Otra información relevante.
   - OPAs (Real Decreto 1066/2007).
   - Gestión colectiva (LMIC + RGCIIC).
   - Asesoramiento financiero (MiFID II).
   - Folletos (Prospectus Regulation).

2. **`mcp__robin__buscar_cnmv`** sobre el asunto.

3. **Procedimientos sancionadores CNMV**: especial régimen + recurso
   ante AN.

4. **Doctrina CNMV + Sala 3ª AN/TS**.

5. **Verifica citas**.

## Avisos típicos

- Información privilegiada: doble régimen administrativo (MAR) y
  penal (art. 285 CP).
- MiCA (Reglamento UE 2023/1114): criptoactivos, distinción con
