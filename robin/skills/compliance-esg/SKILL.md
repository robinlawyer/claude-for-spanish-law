...
name: compliance-esg
description: >
  Cumplimiento ESG: Directiva CSRD (Reglamento Delegado 2023/2772), Taxonomía
  UE, CS3D (diligencia debida en sostenibilidad), normativa nacional.
argument-hint: "[empresa + tamaño + sector + obligaciones aplicables]"
---

# /robin:compliance-esg

Pipeline:

1. **Identificar obligaciones aplicables**:
   - **CSRD (Directiva (UE) 2022/2464)**: reporting de sostenibilidad
     en estados financieros. Calendario escalonado por tamaño.
   - **CS3D (Directiva (UE) 2024/1760)**: diligencia debida en
     cadena de valor sobre derechos humanos y medio ambiente.
     Aplicable a grandes empresas desde 2027.
   - **Taxonomía UE (Reglamento 2020/852)**: clasificación de
     actividades sostenibles.
   - **Ley 11/2018** (Estado de información no financiera) — España.

2. **`mcp__robin__auditar_compliance_*`** según ámbito.

3. **Estados financieros + memoria sostenibilidad**: integrar.

4. **Verificación independiente** obligatoria.

5. **Doctrina supervisor (CNMV en cotizadas)**: criterios de
   reporting.
...
- Greenwashing: riesgo regulatorio (CNMV) y reputacional.
- Cadena de valor: trazabilidad de proveedores en sectores
  sensibles.
- Régimen transitorio: ajustar calendario por tamaño y sector.
