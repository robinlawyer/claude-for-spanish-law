---
name: compliance-programa-31bis
description: >
  Diseño e implementación de programa de prevención penal (art. 31 bis CP).
  Mapa de riesgos, controles, canal de denuncias, formación, evaluación.
argument-hint: "[empresa + sector + tamaño + riesgos detectados]"
---

# /robin:compliance-programa-31bis

Pipeline:

1. **`mcp__robin__auditar_compliance_penal_corporativo`** con datos
   de la empresa. Evalúa madurez del programa actual.

2. **Mapa de riesgos penales por sector**:
   - Delitos corporativos: estafa, blanqueo, contra Hacienda, contra
     SS, contra trabajadores, medioambiente, mercado, fraude
     subvenciones, soborno, urbanístico.
   - Sector-específicos: ciberdelitos, propiedad intelectual,
     publicidad fraudulenta.

3. **Programa**: mapa de riesgos + controles + protocolos +
   procedimiento de toma de decisiones + sistema disciplinario interno.

4. **Compliance officer**: designación, autonomía, recursos.

5. **Canal de denuncias** (LO 2/2023). `/robin:compliance-whistleblowing`.

6. **Formación**: plan anual obligatorio.

7. **Evaluación periódica**: revisión bienal + tras cambios
   normativos / incidentes.

8. **Doctrina TS Sala 2ª**: STS 154/2016 *Multiservicios Madrid* y
   posteriores sobre eficacia.

9. **Verifica citas**.

## Formato

Programa documental + procedimientos + matriz de roles + plan de
formación.

## Avisos típicos

- Programa cosmético: no exime. La doctrina TS exige eficacia real.
- Auto-investigación interna sobre presunto delito: cuidado con
  cadena de custodia y secreto profesional.
