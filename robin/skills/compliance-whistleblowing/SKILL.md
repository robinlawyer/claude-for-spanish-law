---
name: compliance-whistleblowing
description: >
  Canal interno de denuncias (LO 2/2023). Obligatorio para entidades > 50
  empleados, entidades públicas, partidos políticos. Configuración +
  procedimiento + protección del informante.
argument-hint: "[entidad + sector + tamaño]"
---

# /robin:compliance-whistleblowing

Pipeline:

1. **¿Obligatoria?** Sí si:
   - Empresas privadas con ≥ 50 trabajadores.
   - Cualquier entidad del sector público.
   - Partidos políticos, sindicatos, fundaciones que reciban fondos
     públicos.

2. **`mcp__robin__auditar_compliance_whistleblowing`**.

3. **Configuración del canal**:
   - Canal interno + canal externo (Autoridad Independiente de
     Protección del Informante, AAI).
   - Confidencialidad o anonimato (recomendable permitir anónimo).
   - Responsable del Sistema (alta dirección, autónomo).
   - Procedimientos: acuse recibo (7 días), investigación (3 meses
     + prórroga), comunicación final.

4. **Protección del informante**: prohibición represalias,
   confidencialidad de identidad, posible apoyo psicológico,
   jurídico, económico.

5. **Sanciones**: hasta 1 M€ (graves), inhabilitación.

6. **Verifica citas**.

## Avisos típicos

- Protección del denunciado: presunción de inocencia, derecho a la
  audiencia.
- Acceso de la AAI al canal interno: solo en supuestos cualificados.
- Compatible y complementario con compliance penal 31 bis.
