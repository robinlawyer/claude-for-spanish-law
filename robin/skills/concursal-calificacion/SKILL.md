---
name: concursal-calificacion
description: >
  Pieza de calificación del concurso (arts. 442 ss TRLC). Concurso fortuito
  o culpable; responsabilidad concursal de administradores.
argument-hint: "[concurso + perspectiva (administración concursal, deudor, MF, parte interesada)]"
---
...
1. **Apertura de la pieza**: en liquidación o si convenio gravoso.

2. **Análisis de causas culpables** (art. 443 TRLC): irregularidades
   contables, alzamiento, negativa a colaborar, retraso en concurso,
   etc.

3. **Personas afectadas**: administradores, apoderados generales,
   cómplices.

4. **`mcp__robin__preparar_escrito_concursal`** con tipo=calificacion.

5. **Consecuencias del concurso culpable**:
   - Inhabilitación 2-15 años.
   - Devolución de bienes / restitución de cantidades.
   - Cobertura del déficit (responsabilidad concursal).

6. **Doctrina TS Sala 1ª** sobre responsabilidad concursal.

7. **Verifica citas**.

## Avisos típicos

- Acuerdo no jurisdiccional TS sobre criterios uniformes:
  vía `mcp__robin__buscar_jurisprudencia` con query "acuerdo no
  jurisdiccional Pleno TS concursal" (la tool dedicada
  `buscar_acuerdo_pleno_ts` está pendiente en backend).
- Concursal culpable no compatible con homologación de plan de
  reestructuración exitoso previo (en general).
