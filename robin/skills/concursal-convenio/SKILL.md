---
name: concursal-convenio
description: >
  Propuesta de convenio concursal (arts. 315 y ss. TRLC): contenido, quitas y
  esperas, proposiciones alternativas, adhesiones y mayorías del art. 376 TRLC,
  aprobación judicial, cumplimiento e incumplimiento.
argument-hint: "[concursado + fase + estructura de pasivo + contenido propuesto]"
---

# /robin:concursal-convenio
...
1. Llama a la tool `obtener_skill` del MCP de Robin
   (`mcp__robin__obtener_skill`) con `nombre: "concursal-convenio"`.
