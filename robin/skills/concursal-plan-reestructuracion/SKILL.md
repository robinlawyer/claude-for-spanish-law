---
name: concursal-plan-reestructuracion
description: >
  Diseño, negociación y homologación de plan de reestructuración (Libro
  Segundo TRLC tras RDLey 5/2023).
argument-hint: "[deudor + acreedores + clases + propuesta]"
---
...
1. **Análisis financiero**: viabilidad, escenarios de mayor valor
   esperable.

2. **Diseño de clases de acreedores** (TRLC art. 622 ss):
   privilegiados, ordinarios, subordinados, con garantía real, etc.

3. **Propuesta**: quitas, esperas, conversión deuda en capital,
   aportaciones nuevas, etc.

4. **`mcp__robin__preparar_escrito_concursal`** con
   tipo=plan_reestructuracion.

5. **Aprobación**:
   - Sin arrastre: unanimidad de cada clase afectada.
   - Con arrastre intra-clase: mayoría 2/3 de la clase.
   - Con arrastre inter-clase: 1 clase favorable de cada nivel de
     prelación + cumplimiento del best interest test + prohibición
     de incumplimiento de la regla de la prioridad absoluta.

6. **Homologación judicial** + recurso de impugnación.

7. **Doctrina TJUE** sobre Directiva (UE) 2019/1023 que el RDLey
   transpuso.
...
- Best interest test: ningún acreedor disidente puede quedar peor que
  en concurso.
- Financiación interina y nueva: protección frente a rescisorias y
  preferencias.
