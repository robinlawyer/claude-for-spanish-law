---
name: concursal-segunda-oportunidad
description: >
  Mecanismo de segunda oportunidad para persona natural (LSO + Libro Tercero
  TRLC). Exoneración del pasivo insatisfecho (EPI).
argument-hint: "[deudor persona física + pasivo + situación económica]"
---

# /robin:concursal-segunda-oportunidad

Pipeline:

1. **Verificar requisitos** (art. 487 TRLC): persona natural, deudor
   de buena fe (no condenado por delitos contra patrimonio,
   socioeconómicos, falsedad documental, Hacienda Pública, SS).

2. **Procedimientos**:
   - Concurso consecutivo o acuerdo extrajudicial de pagos previo.
   - **Concurso de la persona física** + plan de pagos / liquidación.
   - **EPI** (exoneración del pasivo insatisfecho): sujeta a plan de
     pagos (5 años) o liquidación con pérdida vivienda habitual.

3. **`mcp__robin__preparar_escrito_concursal`** con tipo=segunda_oportunidad.

4. **Deuda no exonerable**: créditos por alimentos, créditos laborales
   en parte, créditos públicos (con limitaciones), créditos derivados
   de delito.

5. **Doctrina TJUE**: sentencia *Soros* sobre alcance EPI.

6. **Verifica citas**.

## Avisos típicos

- La reforma del RDLey 5/2023 permite EPI sin liquidación previa de
  vivienda habitual bajo condiciones.
- Crédito público (Hacienda, SS): exoneración limitada a 10.000 €
  cada uno (límites de 2023).
