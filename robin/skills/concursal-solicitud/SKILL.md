---
name: concursal-solicitud
description: >
  Solicitud de concurso voluntario o necesario (TRLC). Deudor en insolvencia
  actual o inminente. Documentación y trámite ante Juzgado Mercantil.
argument-hint: "[deudor + insolvencia + tipo voluntario/necesario]"
---

# /robin:concursal-solicitud

Pipeline:

1. **Verificar insolvencia** (art. 2 TRLC): actual (no puede cumplir
   regularmente sus obligaciones) o inminente.

2. **Deber del deudor**: solicitar concurso voluntario en 2 meses
   desde conocimiento de insolvencia actual (art. 5 TRLC), salvo
   comunicación del art. 583 (preconcurso).

3. **Concurso necesario**: acreedor puede instarlo (presunciones
   art. 2.4 TRLC: ejecuciones infructuosas, falta de pago a
   trabajadores, embargos generalizados).

4. **`mcp__robin__preparar_escrito_concursal`** con tipo=solicitud +
   modalidad.

5. **Documentación obligatoria** (arts. 6-8 TRLC): memoria,
   inventario, lista de acreedores, cuentas anuales, etc.

6. **Jurisdicción**: Sección de lo Mercantil del Tribunal de
   Instancia del centro de intereses principales (competencia
   integrada tras LO 1/2025).

7. **Doctrina TS Sala 1ª** sobre presupuestos del concurso.

8. **Verifica citas**.

## Avisos típicos

- Concurso fraudulento: responsabilidad penal del administrador.
- Posible solicitud conjunta con plan de reestructuración (RDLey
  5/2023) si encaja.
