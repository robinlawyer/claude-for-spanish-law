---
name: contrato-distribucion
description: >
  Contrato de distribución comercial. Exclusiva o no. Atípico en España (CC
  + jurisprudencia que aplica analogía con LCA en algunos puntos).
argument-hint: "[productos + territorio + duración + exclusiva + lado representado]"
---

# /robin:contrato-distribucion

Pipeline:

1. **Marco jurídico**. Contrato atípico en España. Jurisprudencia TS
   aplica analógicamente la Ley 12/1992 de Contrato de Agencia (LCA)
   en lo referente a la indemnización por clientela (no por daños y
   perjuicios — discutido). `/robin:jurisprudencia --norma "LCA"
   --organo TS`.

2. **`mcp__robin__preparar_redaccion_contrato`** con tipo=distribucion.

3. **Bloques**:
   - Productos / servicios objeto.
   - Territorio (con exclusiva o no).
   - Compromiso de compras mínimas.
   - Política de precios sugeridos (jamás "impuestos" — riesgo
     competencia, derecho UE).
   - Imagen de marca y marketing.
   - Garantías al distribuidor frente al consumidor final.
   - Stock, devoluciones, productos obsoletos.
   - Cambio de control del distribuidor o del proveedor.
   - Duración y preaviso de terminación.
   - Indemnización por clientela (regulación expresa para evitar
     incertidumbre).
   - Ley aplicable y jurisdicción.

4. **Verificación con derecho de competencia** (Reglamento UE
   2022/720 de restricciones verticales — vigente). Restricciones
   sobre precios, ventas online, geo-blocking, etc.

5. **Verifica citas**.

## Avisos típicos

- Indemnización por clientela en distribución: doctrina TS no
  uniforme. STS Sala 1ª variable.
- Cláusulas que fijan precio de reventa = restricción hardcore en
  competencia. Evitar.
- Geo-blocking entre Estados UE: prohibido salvo justificación.
