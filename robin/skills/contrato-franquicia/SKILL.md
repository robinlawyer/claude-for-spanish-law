---
name: contrato-franquicia
description: >
  Contrato de franquicia. Regido por Ley 7/1996 de Comercio Minorista (LOCM
  art. 62) + Reglamento UE 2022/720 (restricciones verticales).
argument-hint: "[franquiciador + franquiciado + know-how + territorio + canon]"
---

# /robin:contrato-franquicia

Pipeline:

1. **Marco jurídico**:
   - LOCM art. 62 + RD 201/2010 sobre registro de franquiciadores.
   - Reglamento UE 2022/720 (vertical block exemption).

2. **Información precontractual obligatoria** (RD 201/2010 art. 3):
   identidad del franquiciador, datos del proyecto, cláusulas
   esenciales del contrato. Entregar al franquiciado al menos 20
   días antes de firmar.

3. **`mcp__robin__preparar_redaccion_contrato`** con tipo=franquicia.

4. **Bloques**:
   - Marca, know-how y asistencia técnica.
   - Territorio + exclusiva (con/sin).
   - Canon de entrada + royalty (% facturación o fijo).
   - Fondo de publicidad.
   - Estándares de imagen, productos, precios sugeridos (NUNCA
     impuestos por competencia).
   - Compras mínimas a proveedores recomendados.
   - Plazo y renovación.
   - Causas de terminación.
   - No competencia: durante + post (máximo 1 año, ámbito limitado
     conforme Reglamento UE).
   - Cesión del local y del fondo de comercio al término.

5. **Verifica citas**.

## Avisos típicos

- Falta de información precontractual: nulidad relativa, el
  franquiciado puede impugnar.
- Imposición de precio de reventa: hardcore en competencia.
  Doctrina CNMC + TJUE.
- Si la franquicia opera en CC.AA con normativa autonómica de
  comercio: verificar requisitos adicionales.
