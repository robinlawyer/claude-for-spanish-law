---
name: contrato-suministro
description: >
  Contrato de suministro (entregas periódicas de bienes a cambio de precio).
  Atípico, regido por CC + CCom analógicamente.
argument-hint: "[bienes + plazo + cantidades + lado representado]"
---

# /robin:contrato-suministro

Pipeline:

1. **Marco**. Contrato atípico. Reglas de compraventa CC/CCom
   aplican analógicamente. Para alimentación, Ley 12/2013 cadena
   alimentaria.

2. **`mcp__robin__preparar_redaccion_contrato`** con tipo=suministro.

3. **Bloques**:
   - Productos: especificaciones, calidades, conformidad.
   - Cantidades: mínimas, máximas, ajustes.
   - Plazo de entrega y lugar.
   - Precio: revisión (índices), forma de pago.
   - Penalizaciones por retraso o defecto.
   - Transferencia del riesgo (Incoterms si transfronterizo).
   - Garantías (saneamiento por vicios ocultos arts. 1484 ss CC).
   - Resolución por incumplimiento esencial.
   - Fuerza mayor (definición + comunicación + efectos).
   - Confidencialidad si hay especificaciones técnicas propietarias.

4. **Si es alimentación**: cumplir Ley 12/2013 (contrato por escrito,
   precio nunca inferior al coste, prohibición de modificaciones
   unilaterales).
...
- Suministros internacionales: Convención de Viena (CISG) aplicable
  salvo exclusión expresa.
- Ley 3/2004 morosidad: plazo de pago máximo 60 días entre empresas
  (30 días entre empresa y AAPP).
- Para servicios continuos (no bienes): tratamiento más cerca de
