---
name: extranjeria-arraigo
description: >
  Solicitudes de autorización por circunstancias excepcionales (arraigo).
  Tras reforma RD 1155/2024: arraigo social, laboral, familiar, formación,
  socio-formativo (nueva figura).
argument-hint: "[tipo de arraigo + permanencia + circunstancias del solicitante]"
---

# /robin:extranjeria-arraigo

Pipeline:

1. **Tipo de arraigo aplicable** (RD 1155/2024):
   - Social: 3 años permanencia + contrato + informe arraigo del
     ayuntamiento.
   - Laboral: 2 años permanencia + acreditar relación laboral
     mínima 6 meses anteriores.
   - Familiar: 2 años o vínculo con español/UE.
   - Formación: empadronamiento + matrícula formación.
   - Socio-formativo: 2 años + formación + compromiso de contratación.

2. **Documentación**: pasaporte vigente, certificados de
   antecedentes país origen y España, certificado empadronamiento
   histórico, justificación arraigo + medios de vida.

3. **`mcp__robin__preparar_tramite_extranjeria`** con tipo=arraigo +
   modalidad.

4. **Procedimiento**: solicitud telemática Mercurio. Plazo de
   resolución 3 meses. Silencio negativo (con excepciones).

5. **Si denegación**: recurso de reposición o contencioso.

6. **Verifica citas**.

## Avisos típicos

- RD 1155/2024 vigente desde 20 mayo 2025: amplió figuras y simplificó
  requisitos.
- Antecedentes penales: cancelables en algunos casos por
  reintegración.
- Permiso por arraigo: 1 año, renovable como ordinario.
