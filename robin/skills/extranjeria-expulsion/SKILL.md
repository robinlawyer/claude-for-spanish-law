---
name: extranjeria-expulsion
description: >
  Recurso contra resolución de expulsión administrativa o judicial. Suspensión
  cautelar, alegaciones de proporcionalidad.
argument-hint: "[resolución + causa + arraigo del afectado]"
---

# /robin:extranjeria-expulsion

Pipeline:

1. **Tipo de expulsión**:
   - Administrativa (LO 4/2000): por estancia irregular, antecedentes,
     etc.
   - Judicial sustitutiva de pena (art. 89 CP).

2. **Doctrina TJUE Boudjlida** y siguientes: necesidad de motivación
   reforzada cuando hay arraigo.

3. **`mcp__robin__preparar_recurso_administrativo`** con tipo=expulsion.

4. **Suspensión cautelar**: imprescindible si plazo de salida
   inminente. `/robin:admin-medidas-cautelares`.

5. **Doctrina TS Sala 3ª** sobre proporcionalidad.

6. **Verifica citas**.

## Avisos típicos

- Si la expulsión afecta a familia con menores escolarizados:
  ponderación reforzada (interés superior del menor).
- CIE: control judicial sobre el internamiento previo a expulsión.
