---
name: extranjeria-nacionalidad
description: >
  Adquisición de la nacionalidad española por residencia, carta de
  naturaleza, opción, matrimonio, descendencia (Memoria Democrática).
argument-hint: "[vía de adquisición + situación del solicitante]"
---

# /robin:extranjeria-nacionalidad

Pipeline:

1. **Vías**:
   - **Por residencia** (art. 22 CC): 10 años regla general. 5 años
     refugiados. 2 años iberoamericanos, Andorra, Filipinas, Guinea
     Ecuatorial, Portugal, sefardíes (Ley 12/2015). 1 año casados
     con español o nacidos en España.
   - **Por opción** (art. 20 CC): hijos de padre/madre originarios.
   - **Por carta de naturaleza**: discrecional del Gobierno.
   - **Memoria democrática** (Ley 20/2022, prorrogada): hijos/nietos
     de españoles exiliados; mayores 18 con padre o madre
     originariamente español por nacimiento.

2. **Requisitos generales art. 22.4 CC**: buena conducta cívica +
   suficiente grado de integración.

3. **Pruebas**: DELE A2 y CCSE (Cervantes) salvo exenciones por edad,
   nacionalidad o capacidad.

4. **`mcp__robin__preparar_tramite_extranjeria`** con tipo=nacionalidad.

5. **Procedimiento**: solicitud telemática. Plazo resolución 1 año;
   silencio negativo.

6. **Si denegación**: recurso de reposición + contencioso.

7. **Verifica citas**.

## Avisos típicos

- Doble nacionalidad: convenios con Iberoamérica, Andorra, Filipinas,
  Guinea Ecuatorial, Portugal, Francia (parcial).
- Renuncia previa a nacionalidad de origen: necesaria en general; no
  necesaria en convenios anteriores.
