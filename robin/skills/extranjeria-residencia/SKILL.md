...
description: >
  Autorizaciones de residencia (no lucrativa, residencia y trabajo por cuenta
  ajena / propia, residencia de larga duración).
argument-hint: "[tipo solicitado + situación actual del extranjero]"
---

# /robin:extranjeria-residencia

Pipeline:

1. **Tipo de autorización**:
   - Residencia no lucrativa (medios económicos + seguro médico).
   - Residencia y trabajo por cuenta ajena (oferta empresa).
   - Residencia y trabajo por cuenta propia (proyecto + capacidad).
   - Residencia de larga duración (5 años residencia legal continuada).
   - Residencia de larga duración UE.

2. **Requisitos específicos** + documentos.

3. **`mcp__robin__preparar_tramite_extranjeria`** con tipo + modalidad.

4. **Procedimiento**: solicitud telemática. Plazos según tipo.

5. **Si concurre cónyuge / hijos**: reagrupación familiar conexa
...
- Residencia no lucrativa: importes mínimos actualizados (IPREM x
  multiplicador). Verificar último.
- Cuenta propia: alta autónomos + visado para emprendedores si
  encaja (Ley 14/2013).
