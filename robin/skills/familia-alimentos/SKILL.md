---
name: familia-alimentos
description: >
  Pensión de alimentos (a favor de menores o entre parientes). Cálculo,
  reclamación, modificación, ejecución.
argument-hint: "[obligado + acreedor + ingresos de ambos + necesidades]"
---

# /robin:familia-alimentos

Pipeline:

1. **Tipo**:
   - Alimentos a hijos menores (deber inherente filiación, arts.
     154-156 CC y forales).
   - Alimentos entre parientes (arts. 142 ss CC).

2. **Foral-check**. Aragón, Cataluña tienen normativa propia.

3. **`mcp__robin__calcular_pension_alimentos`** con ingresos netos
   de ambos progenitores + necesidades del menor + régimen de
   custodia. Tablas orientativas CGPJ.

4. **`mcp__robin__preparar_escrito_familia`** con tipo=alimentos.

5. **Actualización anual** automática (IPC o referencia pactada).
...
- Suspensión / extinción de la pensión por ingresos del hijo mayor
  de edad: doctrina TS estricta.
- Impago: vía civil (ejecución), penal (art. 227 CP abandono de
  familia si concurren requisitos).
