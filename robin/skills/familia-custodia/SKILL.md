---
name: familia-custodia
description: >
  Pretensión de custodia (monoparental o compartida) o modificación de la
  vigente. Interés superior del menor.
argument-hint: "[partes + hijos + situación actual + petición]"
---

# /robin:familia-custodia

Pipeline:

1. **Foral-check**. En Aragón, custodia compartida es legalmente
   preferente (art. 76 CDFA). En CC estatal y resto, evaluación caso
   por caso (interés superior del menor).

2. **Factores que valora el tribunal**:
   - Edad y necesidades del menor.
   - Capacidad de los progenitores.
   - Estabilidad del entorno.
   - Distancia entre domicilios.
   - Posibilidad de continuidad escolar.
   - Audiencia del menor si > 12 años o madurez suficiente.

3. **`mcp__robin__preparar_escrito_familia`** con tipo=custodia.

4. **Equipo psicosocial**: prueba típica decisiva.

5. **Doctrina TS Sala 1ª**: sentencias unificadoras sobre custodia
   compartida.
...
- Coordinador parental: figura en algunas CCAA (Cataluña p.ej.).
- Si violencia de género: custodia monoparental con régimen
  restringido para el agresor (LO 1/2004 + reforma 2022).
