---
name: familia-divorcio
description: >
  Divorcio (consensuado o contencioso). Convenio regulador, medidas
  cautelares, pensión compensatoria, custodia, alimentos. Detector foral
  para régimen económico matrimonial.
argument-hint: "[partes + tipo: mutuo acuerdo / contencioso + hijos + bienes]"
---
...
1. **Foral-check** OBLIGATORIO. Régimen económico matrimonial cambia
   radicalmente: gananciales (CC), separación de bienes (Cataluña,
   Baleares, Valencia post Ley 10/2007 anulada por STC 82/2016 —
   revisar), conquistas (Navarra), comunicación foral en Bizkaia
   (LDCV), etc.

2. **Tipo**:
   - Mutuo acuerdo (art. 86 CC + arts. 777 LEC).
   - Contencioso (art. 81 CC + arts. 770 LEC).
   - Notarial (art. 87 CC) si no hay hijos menores ni discapacidad y
     mutuo acuerdo.

3. **Contenido del convenio regulador** (art. 90 CC):
   - Custodia y régimen de visitas.
   - Pensión de alimentos (`mcp__robin__calcular_pension_alimentos`).
   - Atribución de la vivienda familiar.
   - Pensión compensatoria
     (`mcp__robin__calcular_pension_compensatoria`).
   - Liquidación régimen económico matrimonial.
   - Plan parental si menores.

4. **`mcp__robin__preparar_escrito_familia`** con tipo=divorcio +
   modalidad.

5. **Si hijos menores**: informe Ministerio Fiscal preceptivo.

6. **Doctrina TS Sala 1ª y AAPP del territorio**.

7. **Verifica citas**.

## Formato

Demanda + propuesta de convenio regulador (si MA) o demanda con
medidas (si contencioso).

## Avisos típicos

- Custodia compartida: doctrina TS la potencia salvo perjuicio para
  el menor (no requiere petición conjunta).
- Pensión compensatoria: temporal por defecto; vitalicia
  excepcional.
- Si parejas no casadas: no procede divorcio sino ruptura de pareja
  de hecho (regulación autonómica + jurisprudencia).
