---
name: familia-ejecucion-medidas
description: >
  Ejecución de medidas adoptadas en sentencia / convenio (pago de alimentos,
  régimen de visitas, vivienda). Vía civil o, en su caso, penal.
argument-hint: "[medida incumplida + datos del deudor / progenitor incumplidor]"
---

# /robin:familia-ejecucion-medidas

Pipeline:

1. **Tipo de incumplimiento**:
   - Económico (alimentos, compensatoria): ejecución dineraria.
   - Régimen de visitas: ejecución específica (apercibimiento,
     multas coercitivas, cambio de custodia).
   - Vivienda familiar.

2. **`mcp__robin__preparar_demanda`** con jurisdiccion=familia,
   tipo=ejecucion.

3. **Alternativas penales** si concurren:
   - Art. 227 CP (abandono familia por impago alimentos).
   - Art. 556 CP (resistencia o desobediencia).
...
- Apremio sobre nómina: hasta 50 % salvo dependientes (art. 607 LEC).
- Cambio de custodia por incumplimiento reiterado: doctrina TS
  cautelosa, requiere afectación grave del menor.
