---
name: inmobiliario-arrendamiento-urbano
description: >
  Contrato de arrendamiento urbano (LAU): vivienda, uso distinto. Renta,
  duración, prórrogas, actualización IRAV/IPC, fianza, desahucio.
argument-hint: "[tipo + partes + duración + renta + uso]"
---
...
1. **Calificación**:
   - Vivienda habitual (LAU Tít. II): protección reforzada al
     arrendatario.
   - Uso distinto (Tít. III): libertad contractual amplia.
   - Habitación / temporada: regímenes específicos.

2. **Plazo y prórrogas** (post Ley 12/2023 vivienda):
   - Vivienda habitual: 5 años mínimo (7 si arrendador persona
     jurídica) + 3 prórrogas tácitas anuales.
   - Zonas tensionadas: límites adicionales y prórroga extraordinaria.

3. **Actualización de renta**: IRAV anual (límite Ley 12/2023);
   `mcp__robin__calcular_actualizacion_renta` con índice y fecha.

4. **Fianza** (1 mensualidad vivienda, 2 uso distinto). Depósito
   organismo autonómico obligatorio en mayoría CCAA.

5. **`mcp__robin__preparar_redaccion_contrato`** con tipo=arrendamiento_urbano.

6. **Desahucio**: por falta de pago (art. 27 LAU) o por expiración
   (art. 9). Procedimiento art. 437 ss LEC.

7. **Foral-check**: LAU es estatal pero algunas CCAA tienen normativa
   complementaria (Cataluña — Llei 11/2020 sobre contención rentas;
...
- Ley 12/2023 zonas tensionadas: índice de referencia + límites de
  subida. Aplicable según declaración autonómica.
- Vivienda turística / temporal: cauces distintos, fraude habitual
  para evitar LAU vivienda.
