---
name: inmobiliario-compraventa
description: >
  Compraventa de inmueble. Saneamiento, vicios ocultos, doble venta,
  retracto, anotación preventiva, escritura, ITPyAJD.
argument-hint: "[partes + inmueble + precio + posición]"
---

# /robin:inmobiliario-compraventa

Pipeline:

1. **Foral-check**. Tanteo y retracto pueden tener regímenes
   forales propios (Galicia, Aragón, Cataluña).

2. **Cargas del inmueble**: comprobación registral previa al
   contrato.

3. **Documentos obligatorios**: certificado eficiencia energética,
   cédula habitabilidad si vivienda, IBI al día, certificado de
   estar al corriente con la comunidad.

4. **Contrato**:
   - Arras (penitenciales / confirmatorias / penales — art. 1454 CC).
   - Compraventa privada con condiciones suspensivas (financiación,
     licencias).
   - Escritura pública ante notario.

5. **`mcp__robin__preparar_redaccion_contrato`** con tipo=compraventa_inmueble.

6. **Saneamiento por evicción** (arts. 1475 ss CC) y **vicios
   ocultos** (arts. 1484 ss CC, plazo 6 meses).

7. **Doble venta**: art. 1473 CC — gana quien inscribe primero de
   buena fe; en su defecto, posesión; en su defecto, fecha del
   título.

8. **Fiscalidad**: ITP (% según CCAA) o IVA + AJD si nuevo.

9. **Verifica citas**.

## Avisos típicos

- Si vendedor casado en gananciales: consentimiento del cónyuge
  esencial.
- Plusvalía municipal: STC 182/2021 limita; `mcp__robin__calcular_plusvalia_municipal`.
- Inmueble arrendado: tanteo y retracto del arrendatario salvo
  renuncia.
