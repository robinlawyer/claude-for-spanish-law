---
name: inmobiliario-expropiacion
description: >
  Expropiación forzosa: justiprecio, vía de hecho, retasación, intereses,
  reversión.
argument-hint: "[expediente + posición (expropiado / Administración) + cuestión]"
---
...
1. **Vía**:
   - Ordinaria (LEF + REF + ley sectorial).
   - Urgente.
   - Vía de hecho (sin expediente).

2. **Justiprecio**: hoja del expropiado, hoja de la Administración,
   acuerdo o Jurado de Expropiación, contencioso.

3. **Cálculo** con valoración real + intereses art. 56 LEF.

4. **`mcp__robin__preparar_recurso_administrativo`** con
   tipo=expropiacion.

5. **Reversión**: derecho si no se ejecuta la finalidad (art. 54
   LEF).

6. **Doctrina Sala 3ª TS**.

7. **Verifica citas**.

## Avisos típicos

- Vía de hecho: protección urgente vía interdicto + contencioso por
  responsabilidad patrimonial.
- Justiprecio en sistemas generales / dotaciones: tratamiento
  diferenciado por la jurisprudencia.
