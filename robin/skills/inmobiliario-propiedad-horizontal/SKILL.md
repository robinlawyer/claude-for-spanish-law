---
name: inmobiliario-propiedad-horizontal
description: >
  Régimen de propiedad horizontal (Ley 49/1960 LPH). Acuerdos comunitarios,
  cuotas, impugnación, obras, accesibilidad.
argument-hint: "[asunto + comunidad + propietario + acuerdo si impugnado]"
---
...
1. **Identificar tipo de cuestión**:
   - Impugnación de acuerdo de junta (art. 18 LPH).
   - Reclamación de cuotas (proceso monitorio especial PH art. 21).
   - Obras (mayorías art. 17 LPH).
   - Accesibilidad (art. 10 LPH — obras obligatorias).

2. **Plazo de impugnación**: 1 año (acuerdos contrarios a ley) /
   3 meses (resto).

3. **Mayorías**:
   - Unanimidad: modificación título constitutivo (con excepciones
     LPH).
   - 3/5: obras voluntarias, nuevas instalaciones, vehículos
     eléctricos.
   - Mayoría simple: gestión ordinaria, cargos.
   - Adopción por silencio de los no presentes / no manifestados.

4. **`mcp__robin__preparar_demanda`** con tipo=propiedad_horizontal.

5. **Proceso monitorio especial** para cuotas: certificación del
   secretario-administrador con visto bueno del presidente.

6. **Doctrina TS Sala 1ª**.

7. **Verifica citas**.

## Avisos típicos

- Acuerdo nulo: imprescriptible la acción.
- Falta de quórum / convocatoria defectuosa: nulidad.
- Obras de accesibilidad para persona con discapacidad: obligatorias
  si solicitadas, hasta 12 mensualidades.
