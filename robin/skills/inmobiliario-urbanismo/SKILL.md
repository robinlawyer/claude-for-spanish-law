...
description: >
  Urbanismo: licencias, disciplina urbanística, planeamiento, infracciones.
  TRLS estatal + ley urbanística autonómica + ordenanzas municipales.
argument-hint: "[cuestión + inmueble + ámbito (CCAA) + posición]"
---

# /robin:inmobiliario-urbanismo

Pipeline:

1. **Identificar normativa autonómica aplicable**: cada CCAA tiene su
   ley urbanística. `mcp__robin__buscar_por_ccaa` con la CCAA del
   inmueble + "urbanismo".

2. **Tipo de cuestión**:
   - Licencia (obras, actividad, primera ocupación).
   - Disciplina urbanística (orden de demolición, expediente
     sancionador).
   - Planeamiento (impugnación, modificación).
   - Justiprecio expropiatorio (`/robin:inmobiliario-expropiacion`).
   - Servidumbres urbanas.

3. **`mcp__robin__preparar_recurso_administrativo`** con tipo=urbanismo.

4. **Plazos críticos**:
   - Caducidad de la acción de protección de la legalidad: 4 años
     (puede prolongarse en suelos no urbanizables o de especial
     protección).
   - Plazos de licencia y silencio: según norma autonómica.

5. **Doctrina Sala 3ª TS y TSJ del territorio**. Doctrina
   urbanística muy autonomizada.

6. **Verifica citas**.

## Avisos típicos

- Obras sin licencia en suelo no urbanizable: no prescriben acciones.
- Licencia por silencio: no procede para actos contrarios a
  ordenación (art. 11 TRLS).
