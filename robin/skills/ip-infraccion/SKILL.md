...
1. **Identificar derecho infringido** y titular legitimado.

2. **Acciones**:
   - Cesación (art. 41.1.a LM, art. 71.2.a LP, art. 138 LPI).
   - Retirada del tráfico económico.
   - Indemnización (daños emergentes, lucro cesante o regalía
     hipotética).
   - Destrucción / desinversión.
   - Publicación de la sentencia.

3. **Medidas cautelares**: cesación cautelar, secuestro, fianza.

4. **`mcp__robin__preparar_demanda_pi`** con tipo=infraccion +
   derecho.

5. **Cuantificación de daños**: regalía hipotética (preferida en
   práctica), criterio de beneficios obtenidos por infractor,
   criterio de regalía pactada con titular.

6. **Jurisdicción**: Sección de lo Mercantil del Tribunal de
   Instancia del lugar del infractor o donde se haya producido la
   infracción (competencia integrada tras LO 1/2025).

7. **Doctrina TS Sala 1ª, TJUE, TGUE**.

8. **Verifica citas**.

## Avisos típicos

- Carta de cese (cease and desist): puede ser conveniente como paso
  previo, pero abre riesgo de acción declarativa negativa del
  presunto infractor.
- Patentes esenciales (FRAND): doctrina TJUE *Huawei v ZTE*.
