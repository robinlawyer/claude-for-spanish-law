...
name: ip-licencia
description: >
  Contrato de licencia de marca, patente, software u obra. Exclusiva o no,
  territorio, royalties, control de calidad.
argument-hint: "[derecho + partes + alcance + remuneración + lado representado]"
---
...
1. **Tipo**: exclusiva / no exclusiva / única. Territorio. Plazo.

2. **`mcp__robin__preparar_redaccion_contrato`** con tipo=licencia_pi.

3. **Cláusulas críticas**:
   - Definición del derecho licenciado.
   - Royalty (fijo, variable, mínimo garantizado, escalado).
   - Control de calidad (esencial en marca para evitar
     degeneración).
   - Sublicencia (admitida o no).
   - Auditoría de royalties.
   - Marketing y uso del signo.
   - Indemnidad por infracción de derechos de tercero.
   - Terminación + efectos.

4. **Competencia (Reglamento UE 2022/720)**: cuidado con cláusulas
   restrictivas (precio mínimo de reventa, exclusividad excesiva).

5. **Implicaciones tributarias** (cánones, retención IRNR si
   licenciante no residente).

6. **Verifica citas**.

## Avisos típicos

- Licencia de marca sin control de calidad: riesgo de licencia
  vacía y degeneración del signo.
- Software licensing: SaaS, on-prem, open source — cada modelo con
