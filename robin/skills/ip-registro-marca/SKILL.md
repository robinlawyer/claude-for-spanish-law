---
name: ip-registro-marca
description: >
  Solicitud de registro de marca ante OEPM o EUIPO (marca UE). Análisis de
  distintividad, búsqueda de anterioridades, oposiciones.
argument-hint: "[signo + clases Niza + ámbito (nacional/UE/internacional)]"
---

# /robin:ip-registro-marca

Pipeline:

1. **Análisis de distintividad** (Ley 17/2001 LM + Reglamento UE
   2017/1001 RMUE): denominativa, gráfica, mixta, tridimensional,
   sonora, multimedia. Prohibiciones absolutas (descriptividad,
   uso común, contrariedad a orden público).

2. **Búsqueda de anterioridades**: OEPM, EUIPO, WIPO base
   internacional.

3. **Clases Niza**: 45 clases (productos 1-34, servicios 35-45).

4. **`mcp__robin__preparar_solicitud_pi`** con tipo=marca.

5. **Procedimiento**:
   - OEPM: 6-8 meses si sin oposición.
   - EUIPO: 4-6 meses.
   - Internacional vía Madrid.

6. **Oposiciones**: 2 meses desde publicación. Atender / contestar.

7. **Doctrina OEPM, TJUE y TS Sala 1ª** sobre signos confundibles.

8. **Verifica citas**.

## Avisos típicos

- Marca renombrada: protección reforzada incluso fuera de clase
  registrada (art. 8 LM, art. 9 RMUE).
- Mala fe: art. 51.1.b RMUE + 51.1.c LM. Causa de nulidad.
