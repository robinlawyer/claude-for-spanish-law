...
name: ip-software
description: >
  Software como obra: propiedad, licencias, software libre (cumplimiento
  GPL/MIT/Apache), open source compliance, fronteras con patente.
argument-hint: "[software + relación contractual + cuestión]"
---
...
1. **Marco**: LPI arts. 95-104 + art. 17 LPI (obras por encargo) +
   art. 51 LPI (transmisión inter vivos).

2. **Titularidad**:
   - Software encargado: presunción de cesión al comitente (art. 97
     LPI), con alcance limitado.
   - Software de empleado: cesión al empresario salvo pacto.
   - Software colaborativo: copropiedad en cuotas.

3. **Licencias open source**: GPL (copyleft fuerte), LGPL (mixed),
   MIT/BSD/Apache (permisivas). Cumplimiento: avisos de copyright,
   distribución del código fuente, compatibilidad de licencias.

4. **`mcp__robin__preparar_redaccion_contrato`** con tipo=software o
   `mcp__robin__preparar_dictamen` para auditoría OSS.

5. **Doctrina TS Sala 1ª y TJUE** sobre software (UsedSoft, Oracle).

6. **Verifica citas**.

## Avisos típicos

- Combinar GPL con código propietario en el mismo binario: riesgo
  de "copyleft contagioso".
- Software como invención implementada por ordenador: patentable
  bajo EPO si efecto técnico.
