---
name: laboral-demanda-social
description: >
  Demanda ante el Juzgado de lo Social. Despido, cantidad, tutela de
  derechos fundamentales, prestaciones SS, conflicto individual o colectivo.
argument-hint: "[pretensión + datos del trabajador + empresa + hechos]"
---

# /robin:laboral-demanda-social

Pipeline:

1. **Modalidad procesal** (LRJS): ordinario, despido, conflicto
   colectivo, impugnación convenio, vacaciones, tutela derechos
   fundamentales, prestaciones SS.

2. **Conciliación previa** SMAC (si exigida) →
   `/robin:laboral-conciliacion-smac` antes.

3. **Plazo**:
   - Despido: 20 días hábiles desde decisión empresarial (con
     papeleta SMAC interrumpe).
   - Cantidad: 1 año.
   - Otras: según modalidad.

4. **`mcp__robin__preparar_demanda`** con jurisdiccion=social.

5. **Doctrina TS Sala 4ª y TSJ del territorio**.

6. **Tasa**: trabajadores exentos (LO 1/1996). Empresarios: tasa.

7. **Verifica citas**.

## Formato

Demanda LRJS art. 80 (encabezamiento, hechos, fundamentos,
suplica).

## Avisos típicos

- Tutela de derechos fundamentales: tramitación urgente (art. 178
  LRJS); indemnización por daños y perjuicios.
- Conflicto colectivo: legitimación específica (representantes
  legales, sindicatos).
