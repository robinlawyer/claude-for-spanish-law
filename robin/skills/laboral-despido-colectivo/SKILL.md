...
1. **Umbral** (art. 51.1 ET): % de plantilla afectada en 90 días.

2. **Causa** (económica, técnica, organizativa o productiva): cada
   una con su exigencia probatoria.

3. **Procedimiento**:
   - Comunicación a la representación legal y autoridad laboral.
   - Comisión negociadora (15 días naturales para constituirla).
   - Período de consultas (30 días, 15 si < 50 trabajadores).
   - Acuerdo o falta de acuerdo; decisión empresarial.

4. **Plan de acompañamiento social** si despido colectivo en empresa
   > 50 trabajadores (art. 51.10 ET).

5. **`mcp__robin__preparar_supuesto`** con tipo=ere.

6. **Si despido de mayores de 50 años en empresa con beneficios**:
   aportación al Tesoro (RD-Ley 5/2013).

7. **Indemnizaciones**: 20 días/año, máx 12 mensualidades (mínimo
   legal; convenios pueden mejorar; en consultas se pacta a veces más).

8. **Impugnación**:
   - Colectiva: ante TSJ o AN (art. 124 LRJS).
   - Individual: cada trabajador puede impugnar despido individual
     en 20 días hábiles tras decisión empresarial.

9. **Jurisprudencia abundante TS Sala 4ª**.

10. **Verifica citas**.

## Avisos típicos

- Defecto formal en el período de consultas: nulidad del ERE.
- Discriminación encubierta en selección: nulidad.
- Sucesión de empresas + ERE: cuidado con la dimensión empresa
  para el umbral.
