...
description: >
  ...
  Individual o colectiva, procedimiento, opciones del trabajador.
argument-hint: "[modificación propuesta + trabajadores afectados + causa]"
---
...
1. **Verificar que es MSCT** (art. 41.1 ET, lista no exhaustiva):
   jornada, horario, régimen de turnos, sistema de remuneración y
   cuantía salarial, sistema de trabajo y rendimiento, funciones
   excediendo art. 39 ET.

2. **Individual vs. colectiva**: umbrales del art. 41.2 ET. Si
   colectiva, período de consultas.

3. **Causa**: económica, técnica, organizativa o productiva. Debe
   acreditarse.

4. **Notificación** al trabajador y representantes (15 días si
   colectiva, 30 si individual).

5. **Opciones del trabajador**:
   - Aceptar.
   - Impugnar (20 días hábiles tras notificación).
   - Si la MSCT le perjudica gravemente, extinción con derecho a
     indemnización (art. 41.3 ET): 20 días/año, máx 9 mensualidades.

6. **`mcp__robin__preparar_supuesto`** con tipo=msct.
