---
name: laboral-prestacion-ss
description: >
  Cálculo y reclamación de prestaciones de la Seguridad Social: IT, IP
  (parcial / total / absoluta / gran invalidez), jubilación, viudedad,
  orfandad, desempleo.
argument-hint: "[tipo prestación + datos cotización + edad + situación]"
---
...
1. **Identificar prestación** y régimen aplicable (general /
   autónomos / especiales).

2. **Verificar requisitos**: alta, cotización mínima, edad, hecho
   causante.

3. **`mcp__robin__calcular_prestacion_seguridad_social`** con datos.

4. **Procedimiento**:
   - Solicitud INSS / ISM / SEPE.
   - Resolución (plazos legales).
   - Si denegatoria: reclamación previa ante INSS en 30 días
     (art. 71 LRJS).
   - Demanda social en 30 días desde resolución reclamación previa.

5. **Doctrina TS Sala 4ª**.

6. **Verifica citas**.

## Avisos típicos

- IP derivada de accidente de trabajo: base reguladora distinta
  (más favorable).
- Pensión SOVI / clases pasivas: regímenes propios.
- Cómputo recíproco de cuotas entre regímenes: especial atención
  al art. 197 LGSS.
