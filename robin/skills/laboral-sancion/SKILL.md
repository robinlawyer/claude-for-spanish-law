---
name: laboral-sancion
description: >
  Sanción disciplinaria al trabajador (carta de sanción) o impugnación de
  sanción recibida. Falta leve, grave, muy grave (convenio + art. 58 ET).
argument-hint: "[lado + hechos + sanción + convenio aplicable]"
---

# /robin:laboral-sancion

Pipeline:

1. **Tipificar la falta**. Convenio colectivo aplicable
   (`mcp__robin__buscar_convenio_colectivo`) define qué es leve /
   grave / muy grave + correspondencia con sanciones.

2. **Plazos de prescripción de las faltas** (art. 60.2 ET): 10 días
   leves, 20 graves, 60 muy graves, desde conocimiento empresarial,
   y 6 meses desde comisión.

3. **Procedimiento sancionador**:
   - Si trabajador es representante legal: expediente contradictorio.
   - Garantías comunes: comunicación por escrito con hechos y fecha
     (art. 58.2 ET).

4. **`mcp__robin__preparar_supuesto`** con tipo=sancion_disciplinaria.

5. **Impugnación** (si lado trabajador): plazo 20 días hábiles
   sociales tras la sanción si grave o muy grave (sin conciliación
   previa SMAC si la sanción no es despido).

6. **Verifica citas**.

## Avisos típicos

- Si la falta no está tipificada en convenio, atipicidad sancionatoria:
  sanción nula.
- Proporcionalidad: TS controla que la sanción se ajuste a la
  gravedad.
