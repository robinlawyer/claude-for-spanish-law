...
name: memorandum
description: >
  Memorándum jurídico interno: análisis técnico sobre cuestión concreta,
  más conciso y técnico que un dictamen, sin tanto formalismo.
argument-hint: "[cuestión + contexto]"
---
...
1. **`mcp__robin__preparar_memorandum`**.

2. **Marco normativo**, **jurisprudencia**, **doctrina**: como
   dictamen pero menos exhaustivo.

3. **Verifica citas**.

## Formato

1. **Cuestión planteada** (1 frase).
2. **Respuesta corta** (1 párrafo).
3. **Marco normativo aplicable**.
4. **Análisis**.
5. **Conclusión razonada**.
6. **Tabla de citas verificadas**.

## Avisos típicos

- Para uso interno del despacho o consumo del cliente sofisticado.
- Si es para cliente no abogado, usar `/robin:informe-juridico`.
