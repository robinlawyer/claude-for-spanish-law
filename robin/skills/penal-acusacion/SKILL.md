---
name: penal-acusacion
description: >
  Escrito de acusación particular o popular. Calificación, pena solicitada,
  responsabilidad civil, prueba.
argument-hint: "[hechos + tipo + responsabilidad civil + prueba]"
---

# /robin:penal-acusacion

Pipeline:

1. **Calificación jurídica**: tipo penal, autoría/participación,
   grado de ejecución, circunstancias modificativas.

2. **Pena solicitada**. `mcp__robin__calcular_pena` con
   atenuantes/agravantes.

3. **Responsabilidad civil**: cuantificar daños materiales, morales,
   lucro cesante. Si tráfico: `mcp__robin__calcular_baremo_trafico`.

4. **Prueba propuesta**: documental, testifical, pericial,
   reconocimiento.

5. **`mcp__robin__preparar_supuesto`** con tipo=escrito_acusacion.

6. **Verifica citas**.

## Avisos típicos

- Acusación popular: doctrina Botín (penales sin perjudicado
  directo no permiten apertura de juicio solo con acusación
  popular contra criterio MF).
- Si víctima es menor / vulnerable: medidas de protección procesales.
