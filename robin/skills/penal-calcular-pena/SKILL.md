---
name: penal-calcular-pena
description: >
  Cálculo de pena conforme CP: marco penal, atenuantes y agravantes (arts.
  21-22 CP), continuidad delictiva (art. 74), concurso (arts. 73, 76-77).
argument-hint: "[tipo penal + circunstancias modificativas]"
---
...
1. **Marco penal abstracto** (artículo CP). Pena básica.

2. **Subtipos**: agravados (acometimiento con armas, en lugares
   determinados, sujetos especiales) o atenuados (cuantías menores,
   primer delito, etc.).

3. **Atenuantes** (art. 21 CP): minoría de edad penal,
   anomalía/alteración psíquica, drogadicción, miedo insuperable,
   confesión, reparación, dilaciones indebidas, analógicas.

4. **Agravantes** (art. 22 CP): alevosía, ensañamiento, abuso
   superioridad, precio, motivos discriminatorios, reincidencia.

5. **Continuidad delictiva** (art. 74 CP): unidad de propósito,
   varios hechos del mismo precepto. Mitad superior obligatoria.

6. **Concurso de delitos** (arts. 73, 76-77 CP): real, ideal, medial.

7. **`mcp__robin__calcular_pena`** con todos los datos.

8. **Verifica citas**.

## Avisos típicos

- Aplicación de regla 30 % de la pena total en concurso (art. 76 CP).
- Sustitución / suspensión: tras determinación de pena, valorar arts.
  80-89 CP.
