...
name: penal-defensa
description: >
  Estrategia y escrito de defensa: contestación a acusación, calificación
  alternativa, prueba de descargo, conclusiones provisionales y definitivas.
argument-hint: "[hechos + tipo acusado + diligencias practicadas + tesis defensa]"
---
...
1. **Estado procesal**: instrucción, fase intermedia, juicio oral,
   sentencia. Cada fase tiene escritos distintos.

2. **Análisis del expediente y de la acusación**.
   `mcp__robin__analizar_expediente` + `mcp__robin__analizar_escrito_contraparte`
   sobre el escrito del MF y/o acusación particular.

3. **Estrategia**:
   - Negación de tipicidad.
   - Eximentes (legítima defensa, estado de necesidad, error,
     trastorno mental).
   - Atenuantes (confesión, reparación, dilaciones, drogadicción).
   - Calificación alternativa más favorable.
   - Tesis de inocencia.

4. **Prueba de descargo**: documental, testifical, pericial.

5. **`mcp__robin__preparar_supuesto`** con tipo=defensa_penal.

6. **Conclusiones provisionales (LECrim art. 652)** y definitivas
   (art. 732).

7. **Calcular pena alternativa**. `mcp__robin__calcular_pena` con la
   calificación de la defensa.

8. **Doctrina TS Sala 2ª**.

9. **Verifica citas**.

## Avisos típicos

- Modificación de conclusiones definitivas más allá de la
  homogeneidad: ineficacia (doctrina TS).
- Suspensión de la pena (art. 80 CP): valorar requisitos al final
  para informe.
