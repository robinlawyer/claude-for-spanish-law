...
name: penal-denuncia
description: >
  Denuncia penal (LECrim arts. 259 ss). Más simple que querella; no
  constituye parte acusadora.
argument-hint: "[hechos + denunciado si identificado + denunciante]"
---

# /robin:penal-denuncia

Pipeline:

1. **Tipificar** los hechos.

2. **Ante quién denunciar**: Tribunal de Instancia (Sección de
   Instrucción) — competencia integrada tras LO 1/2025 —, Ministerio
   Fiscal o Policía Judicial.

3. **`mcp__robin__preparar_querella_o_denuncia`** con tipo=denuncia.

4. **Diligencias a solicitar**.

5. **Verifica citas**.

## Avisos típicos

- Si el denunciante quiere personarse como parte: querella o
  posterior personación como acusación particular cuando se admita
  la denuncia.
- Falsedad en denuncia: delito (art. 456 CP). Cuidar redacción.
