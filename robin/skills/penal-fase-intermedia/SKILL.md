...
1. **Identificar el trámite**:
   - Solicitud de apertura de juicio oral.
   - Solicitud de sobreseimiento provisional o libre.
   - Oposición a sobreseimiento.
   - Petición de archivo.
   - Cuestiones previas (arts. 666 ss LECrim).

2. **`mcp__robin__preparar_escrito_fase_intermedia_penal`** con
   tipo + datos.

3. **Adaptación a modelos CGPJ** post LO 1/2025 cuando exista
   formato oficial.

4. **Doctrina TS Sala 2ª y AAPP penales**.

5. **Verifica citas**.

## Avisos típicos

- Sobreseimiento libre (art. 637 LECrim): efectos de cosa juzgada
  (a diferencia del provisional).
- Cuestiones previas: si no se plantean, preclusión.
