...
name: penal-recurso
description: >
  Recursos penales: reforma, apelación, casación, revisión, amparo.
argument-hint: "[resolución recurrida + motivos]"
---
...
1. **Tipo de recurso**:
   - Reforma (autos del Instructor): 3 días.
   - Apelación contra autos definitivos del Instructor: 5 días.
   - Apelación contra sentencias del JP / JI / AP penal: 10 días.
   - Casación TS Sala 2ª: 5 días.
   - Revisión.
   - Amparo ante TC.

2. **Plazo**. `/robin:plazos`. Atención: penal NO incluye agosto
   inhábil por defecto en diligencias urgentes.

3. **Depósito**. `mcp__robin__deposito_recurso` (penal: variable
   según tipo).

4. **`mcp__robin__preparar_recurso`** con jurisdiccion=penal +
   tipo.

5. **Casación: motivos tasados** (arts. 849-851 LECrim).

6. **Doctrina TS Sala 2ª** abundantísima sobre cada motivo.

7. **Verifica citas**.

## Avisos típicos

- Recursos contra sentencia firme: revisión (art. 954 LECrim) muy
  restrictiva.
- Amparo: agotamiento de la vía previa obligatorio.
