...
description: >
  Resumen ejecutivo de un caso, expediente, escrito largo o conjunto de
  documentos. Para socios, clientes corporativos, comités.
argument-hint: "[texto o expediente a resumir]"
---
...
1. **`mcp__robin__resumen_ejecutivo`** con el material.

2. **Estructura**:
   - Contexto (2-3 líneas).
   - Cuestión jurídica central.
   - Posición / estrategia recomendada.
   - Tres mensajes clave (los que el lector retendría).
   - Próximos hitos críticos.

3. **Brevedad**: 1 página estándar; máximo 2 si el caso es
   excepcionalmente complejo.

4. **Verifica citas** si las hay.

## Avisos típicos

- El resumen ejecutivo NO sustituye al informe completo; lo
  complementa.
- Si el lector es comité de dirección no jurista: lenguaje accesible.
- Si es socio del despacho: lenguaje técnico aceptable.
