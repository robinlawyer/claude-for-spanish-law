...
name: rgpd-ai-act
description: >
  Cumplimiento del Reglamento (UE) 2024/1689 (AI Act) en intersección con
  RGPD. Clasificación del sistema (prohibido / alto riesgo / GPAI / mínimo),
  obligaciones por categoría.
argument-hint: "[sistema de IA + finalidad + datos + usuarios]"
---
...
1. **Clasificación del sistema IA**:
   - **Prohibidos** (art. 5 AI Act): manipulación subliminal,
     puntuación social, identificación biométrica en tiempo real en
     espacios públicos (con excepciones), etc.
   - **Alto riesgo** (Anexo III): empleo, educación, justicia,
     seguros, salud, infraestructuras críticas.
   - **GPAI** (modelos fundacionales).
   - **Mínimo riesgo**.

2. **Obligaciones según categoría**:
   - **Prohibidos**: no comercializables.
   - **Alto riesgo**: registro UE, evaluación de conformidad,
     sistema de gestión de riesgo, datos de entrenamiento sin
     sesgos, supervisión humana, robustez, ciberseguridad,
     transparencia, fundamental rights impact assessment.
   - **GPAI**: documentación técnica + reglamento de aplicación;
     GPAI con riesgo sistémico: notificación + mitigación.
   - **Mínimo**: códigos de conducta voluntarios.

3. **Intersección con RGPD**:
   - Decisiones automatizadas significativas (art. 22 RGPD).
   - Base jurídica para datos de entrenamiento (interés legítimo
     muy delicado).
   - DPIA reforzada.
   - Transparencia hacia los interesados.

4. **`mcp__robin__preparar_dictamen`** con tipo=ai_act.

5. **Doctrina AEPD sobre IA**: `mcp__robin__buscar_aepd con "IA"`
   (escasa todavía, pero creciendo). Doctrina TJUE
   `mcp__robin__buscar_tjue` sobre toma de decisiones automatizadas.

6. **Verifica citas**.

## Formato

Dictamen estructurado por obligación. Roadmap de cumplimiento con
plazos del calendario AI Act (algunas obligaciones aplicables ya,
otras hasta agosto 2026).

## Avisos típicos

- Calendario: prohibiciones desde feb 2025; GPAI desde ago 2025;
  alto riesgo en general agosto 2026.
- Solapamiento con regulación sectorial (medicamentos, sanitario,
  financiero, juguetes).
- Régimen sancionador severo: hasta 35 M€ o 7 % facturación
  mundial para infracciones de prohibiciones.
