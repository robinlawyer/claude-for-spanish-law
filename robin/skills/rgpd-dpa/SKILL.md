...
name: rgpd-dpa
description: >
  Data Processing Agreement (DPA / contrato de encargo del tratamiento) entre
  responsable y encargado conforme art. 28 RGPD.
argument-hint: "[partes + tratamientos + lado representado]"
---
...
1. **Identificar partes**:
   ...
   - Encargado (processor).
   - Posible subencargado (sub-processor).

2. **`mcp__robin__preparar_redaccion_contrato`** con tipo=dpa.

3. **Cláusulas obligatorias art. 28.3 RGPD**:
   - Objeto, duración, naturaleza, finalidad del tratamiento.
   - Tipo de datos personales y categorías de interesados.
   - Obligaciones y derechos del responsable.
   - Instrucciones del responsable.
   - Confidencialidad del personal del encargado.
   - Medidas de seguridad (art. 32 RGPD).
   - Subencargados (autorización general/específica).
   - Asistencia al responsable en cumplimiento de derechos.
   - Asistencia en EIPD, brechas, etc.
   - Devolución o supresión al término.
   - Auditorías.

4. **Cláusulas Tipo Comisión UE**: usar las SCCs si transferencia
   internacional fuera EEE.

5. **Si lado responsable**: instrucciones detalladas, derecho de
   auditoría, lista cerrada de subencargados.

6. **Si lado encargado**: limitar auditorías, cuotas por respuesta
   a DSAR, limitación de responsabilidad.

7. **Verifica citas**.

## Avisos típicos

- Subencargados sin autorización: incumplimiento grave del
  encargado.
- Si el encargado está fuera EEE: combinar DPA + SCC.
- Brechas: el encargado notifica al responsable sin demora
  injustificada, no a AEPD directamente (salvo doble rol).
