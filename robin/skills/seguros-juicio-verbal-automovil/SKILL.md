---
name: seguros-juicio-verbal-automovil
description: >
  Juicio verbal especial del automóvil (art. 250.1.8 LEC). Acción directa
  contra aseguradora. Procedimiento sumario y rápido.
argument-hint: "[accidente + perjudicado + aseguradora del causante]"
---

# /robin:seguros-juicio-verbal-automovil

Pipeline:

1. **Verificar idoneidad**: indemnización de daños y perjuicios
   derivados de hechos de la circulación, sin cuantía máxima.

2. **Acción directa** contra la aseguradora (art. 76 LCS).

3. **Oferta motivada / respuesta motivada** previa (Texto Refundido
   LRCSCVM art. 7.2): obligatoria; impago genera condena por LCS
   art. 20.

4. **`mcp__robin__preparar_demanda`** con tipo=verbal_automovil.

5. **Cuantificación**: `/robin:seguros-baremo-trafico`.

6. **Plazo de prescripción**: 1 año desde estabilización lesiones
   (acción civil contra aseguradora).

7. **Verifica citas**.

## Avisos típicos

- Atestado policial y diligencias previas penales: pieza clave para
  responsabilidad.
- Acción contra aseguradora del propio vehículo: posible en seguros
  voluntarios.
