---
name: seguros-lucro-cesante
description: >
  Reclamación de lucro cesante en sede de daños y perjuicios o seguro.
  Acreditación, cuantificación, doctrina TS.
argument-hint: "[perjudicado + actividad + período + cuantía]"
---

# /robin:seguros-lucro-cesante

Pipeline:

1. **Concepto**: ganancia dejada de obtener, no mera posibilidad.

2. **Acreditación**:
   - Trabajador por cuenta ajena: nóminas no percibidas, certificado
     INSS, certificado empresa.
   - Autónomo: declaraciones tributarias, evolución históricos,
     facturación anterior y posterior.
   - Empresa: contabilidad auditada, pericial económica.

3. **`mcp__robin__calcular_baremo_trafico`** modo lucro cesante (si
   tráfico) o cálculo libre con doctrina TS.

4. **Doctrina TS Sala 1ª**: exigencia de prueba directa, no
   meramente probable.
...
- Lucro cesante de profesional liberal: doctrina TS más exigente que
  con asalariados.
- Lucro cesante con concausalidad (situación previa de paro): TS
  pondera, no excluye.
