---
name: seguros-reclamacion-aseguradora
description: >
  Reclamación contra aseguradora por incumplimiento de contrato de seguro
  (Ley 50/1980 LCS). Recargo por demora del art. 20 LCS.
argument-hint: "[tipo de seguro + siniestro + cuantía reclamada + posición aseguradora]"
---

# /robin:seguros-reclamacion-aseguradora

Pipeline:

1. **Tipo de seguro**: daños (incendio, robo, RC, hogar), personas
   (vida, accidentes, salud), defensa jurídica, decenal (LOE), tráfico.

2. **Cobertura**: revisar póliza + condiciones generales + particulares
   + cláusulas limitativas (LCS art. 3: deben estar destacadas y
   aceptadas expresamente).

3. **Cláusulas abusivas**: cláusulas limitativas no destacadas o
   contrarias a expectativas razonables → nulas.

4. **Recargo por mora del art. 20 LCS**: el interés legal + 50 %
   los dos primeros años; a partir del segundo año, 20 % de interés.

5. **`mcp__robin__preparar_reclamacion_seguros`** con tipo + siniestro.

6. **Plazo de prescripción**: 2 años daños / 5 años personas.

7. **Vía**:
   - Reclamación amistosa.
   - DGSFP (Servicio de Reclamaciones).
   - Demanda civil (juicio ordinario o verbal según cuantía).

8. **Doctrina TS Sala 1ª** sobre interpretación de cláusulas.

9. **Verifica citas**.

## Avisos típicos

- Cláusula limitativa vs. delimitadora: TS exige escrutinio estricto
  para evitar limitaciones encubiertas.
- Defensa jurídica del asegurado: derecho a libre elección de
  abogado (art. 76.d LCS) en juicio o si conflicto de intereses.
