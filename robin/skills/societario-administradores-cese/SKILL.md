---
name: societario-administradores-cese
description: >
  Cese del administrador: renuncia o dimisión, no aceptación del cargo, y baja
  registral cuando la sociedad no inscribe. Comunicación fehaciente, deber de
  convocar junta y responsabilidad mientras la cesación no consta inscrita.
argument-hint: "[administrador + sociedad + renuncia/no aceptación + situación del órgano]"
---

# /robin:societario-administradores-cese
...
1. Llama a la tool `obtener_skill` del MCP de Robin
   (`mcp__robin__obtener_skill`) con `nombre: "societario-administradores-cese"`.
