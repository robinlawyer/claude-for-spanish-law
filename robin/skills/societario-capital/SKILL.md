---
name: societario-capital
description: >
  Operaciones sobre el capital social: aumento con aportación dineraria o no
  dineraria y reducción de capital. Acuerdo de junta, derecho de preferencia,
  informe de experto, oposición de acreedores, escritura e inscripción.
argument-hint: "[tipo aumento-dinerario/aumento-no-dinerario/reducción + sociedad + importe + finalidad]"
---

# /robin:societario-capital
...
1. Llama a la tool `obtener_skill` del MCP de Robin
   (`mcp__robin__obtener_skill`) con `nombre: "societario-capital"`.
