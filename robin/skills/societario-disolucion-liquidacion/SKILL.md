---
name: societario-disolucion-liquidacion
description: >
  Disolución y liquidación de sociedad de capital: causa legal o voluntaria,
  nombramiento de liquidador, operaciones de liquidación, balance final, cuota
  de liquidación y extinción con cancelación registral.
argument-hint: "[sociedad + causa de disolución + situación patrimonial]"
---

# /robin:societario-disolucion-liquidacion
...
1. Llama a la tool `obtener_skill` del MCP de Robin
   (`mcp__robin__obtener_skill`) con `nombre: "societario-disolucion-liquidacion"`.
