---
name: societario-inversion-seed
description: >
  Term sheet de ronda seed o pre-Series A en startup: valoración pre y post
  money, instrumento (equity, préstamo convertible o SAFE), preferencia de
  liquidación, anti-dilución, gobierno, vesting de fundadores y salidas.
argument-hint: "[startup + importe + valoración + instrumento + cap table actual]"
---

# /robin:societario-inversion-seed
...
1. Llama a la tool `obtener_skill` del MCP de Robin
   (`mcp__robin__obtener_skill`) con `nombre: "societario-inversion-seed"`.
