---
name: societario-litigio
description: >
  Litigio societario: impugnación de acuerdos sociales, acciones sociales
  contra administradores, conflicto entre socios.
argument-hint: "[tipo de conflicto + sociedad + parte que demanda/contesta]"
---

# /robin:societario-litigio

Pipeline:

1. **Tipificar la acción**:
   - Impugnación de acuerdo social (LSC arts. 204-208): nulidad o
     anulabilidad.
   - Acción social de responsabilidad de administradores (LSC art.
     238).
   - Acción individual de responsabilidad (LSC art. 241).
   - Acción contra acuerdos del consejo (LSC art. 251).
   - Conflicto de socios (exclusión de socios, separación).

2. **Plazo**:
   - Impugnación acuerdos: 1 año (3 meses si son inscribibles
     contrarios a orden público — sin plazo).
   - Responsabilidad administradores: 4 años (art. 949 CCom).

3. **`mcp__robin__preparar_litigio_societario`** con tipo y datos.

4. **Jurisdicción**. Sección de lo Mercantil del Tribunal de
   Instancia del domicilio social (competencia integrada tras LO
   1/2025).

5. **Refuerzo jurisprudencial**: TS Sala 1ª doctrina societaria,
   AAPP de la sección mercantil del territorio.

6. **Verifica citas**.

## Formato

Demanda mercantil estándar con foco en:
- Legitimación activa (titularidad de participaciones, % requerido).
- Tipificación exacta de la infracción.
- Daño causado y nexo causal (si acción de responsabilidad).

## Avisos típicos

- Impugnaciones a acuerdos por mayoría abusiva: doctrina TS de
  abuso de derecho de la mayoría (STS *Telekenia* y siguientes).
- Para acción social, el % de capital legitimado depende de cómo se
  ejerza (3 % en abuso de mayoría, mayor en supuestos generales).
