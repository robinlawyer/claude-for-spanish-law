---
name: societario-modificacion-estructural
description: >
  Fusión, escisión, transformación, cesión global de activo y pasivo,
  traslado internacional del domicilio. Bajo el RDLey 5/2023 que transpuso
  la Directiva (UE) 2019/2121.
argument-hint: "[tipo de operación + sociedades intervinientes + perímetro]"
---

# /robin:societario-modificacion-estructural

Pipeline:

1. **Identificar operación** y norma aplicable:
   - Fusión (RDLey 5/2023, Libro Primero).
   - Escisión (total, parcial, segregación).
   - Transformación.
   - Cesión global de activo y pasivo.
   - Traslado internacional del domicilio (intra-UE: nuevo régimen
     simplificado).

2. **Fases**:
   a) Proyecto común (de fusión / escisión / etc.) firmado por
      administradores.
   b) Informe de administradores.
   c) Informe de expertos independientes (si procede).
   d) Publicación en BORME y web corporativa.
   e) Junta general (mayoría reforzada).
   f) Derecho de oposición de acreedores (1 mes).
   g) Escritura pública + inscripción Registro Mercantil.

3. **`mcp__robin__preparar_acuerdo_societario`** con
   tipo=modificacion_estructural.

4. **Implicaciones fiscales**:
   - Régimen especial de neutralidad fiscal (LIS arts. 76 ss): si
     procede comunicación a la AEAT.
   - IVA: exento si reestructuración (art. 7.1º LIVA).
   - ITPyAJD: exento (art. 45.I.B LITPyAJD).

5. **Implicaciones laborales**: sucesión empresa (art. 44 ET).
   Comunicación a representantes y a TGSS.

6. **Verifica citas**.

## Formato

Calendario detallado con fechas y entregables. Documentos:
- Proyecto común
- Informe de administradores
- Informe de experto independiente
- Convocatoria junta
- Acuerdo de junta
- Anuncios BORME y web
- Borrador escritura
- Comunicación a acreedores y trabajadores

## Avisos típicos

- Operaciones transfronterizas UE: nuevo régimen RDLey 5/2023 con
  certificación previa por notario y registro mercantil.
- Si la operación afecta a competencia: notificación a CNMC si
  umbrales del art. 8 LDC.
