---
name: societario-pacto-socios
description: >
  Pacto de socios (shareholder agreement). Gobierno, transmisiones,
  protección de minoría, salidas, anti-dilución, drag-along / tag-along.
argument-hint: "[partes + situación accionarial + objetivos del pacto]"
---

# /robin:societario-pacto-socios

Pipeline:

1. **`mcp__robin__preparar_pacto_socios`** con datos.

2. **Bloques estándar**:
   - Gobierno (composición órgano de administración, mayorías
     reforzadas).
   - Régimen de transmisión (derechos de adquisición preferente,
     consentimiento, lock-up).
   - Drag-along (arrastre) y tag-along (acompañamiento).
   - Anti-dilución.
   - Distribución de dividendos.
   - Salidas (IPO, venta, recompra).
   - Resolución de conflictos (shotgun, mediación, arbitraje).
   - Confidencialidad y no competencia.

3. **Coherencia con estatutos**: revisar que el pacto no contradiga
   estatutos vigentes (priman estatutos hacia terceros, pacto solo
   entre firmantes).

4. **Verifica jurisprudencia sobre cláusulas controvertidas**
   (drag-along en minoría que se opone, multas convencionales).

5. **Verifica citas**.

## Avisos típicos

- Las cláusulas que restringen transmisión de participaciones deben
  inscribirse en escritura si quieren oponibilidad frente a tercero.
- Una cláusula leonina o contraria a orden público (privación
  absoluta de derecho de voto) es nula.
- Recomendable un anexo con valoración aprobada para evitar
  conflictos al activar derechos preferentes.
