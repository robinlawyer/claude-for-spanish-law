---
name: societario-responsabilidad-administradores
description: >
  Acción social e individual de responsabilidad de administradores. Deudas
  sociales por incumplimiento de obligaciones legales (causa de disolución,
  no convocatoria).
argument-hint: "[tipo de acción + administradores + sociedad + daño]"
---
...
1. **Tipificación**:
   - **Acción social** (LSC art. 238): por daño al patrimonio social.
     Legitimación: sociedad, socios con 5 % (3 % cotizadas),
     acreedores subsidiariamente.
   - **Acción individual** (LSC art. 241): por daño directo a socio
     o tercero.
   - **Responsabilidad por deudas** (LSC art. 367): por
     incumplimiento de obligación de convocatoria de junta en causa
     de disolución (responde solidariamente de las deudas posteriores
     al hecho).

2. **Plazo**: 4 años (art. 949 CCom) desde el cese.

3. **Elementos a acreditar**:
   - Acto u omisión imputable al administrador.
   - Antijuridicidad (infracción ley, estatutos, diligencia debida).
   - Daño.
   - Nexo causal.

4. **`mcp__robin__preparar_litigio_societario`** con
   tipo=responsabilidad_administrador.

5. **Refuerzo jurisprudencial**:
   - TS Sala 1ª sobre business judgment rule (art. 226 LSC).
   - Doctrina sobre el deber de diligencia (art. 225 LSC).
   - Responsabilidad por deudas: doctrina sobre dies a quo del cómputo.

6. **Verifica citas**.

## Formato

Demanda estándar mercantil con detalle del cuadro fáctico que activa
la responsabilidad.

## Avisos típicos

- La business judgment rule (art. 226 LSC) protege decisiones
  estratégicas adoptadas con información suficiente y de buena fe.
- En sociedades en concurso: dilucidación de responsabilidad ex art.
  172 bis TRLC compatible con acción social.
- Caducidad versus prescripción: tribunales han dudado; mayoritaria
  hoy es prescripción.
