---
name: societario-transmision-participaciones
description: >
  Compraventa de participaciones de SL: régimen estatutario de transmisión,
  derecho de adquisición preferente, consentimiento de la junta, escritura
  pública obligatoria, libro registro de socios y garantías del vendedor.
argument-hint: "[sociedad + vendedor + comprador + nº de participaciones + precio]"
---

# /robin:societario-transmision-participaciones
...
1. Llama a la tool `obtener_skill` del MCP de Robin
   (`mcp__robin__obtener_skill`) con `nombre: "societario-transmision-participaciones"`.
