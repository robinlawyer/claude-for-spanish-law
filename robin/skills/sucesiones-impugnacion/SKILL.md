---
name: sucesiones-impugnacion
description: >
  Acciones sucesorias contenciosas: impugnación de testamento, acción de
  petición de herencia, preterición, lesión de legítima, indignidad sucesoria.
argument-hint: "[acción + causante + impugnante + motivos]"
---

# /robin:sucesiones-impugnacion

Pipeline:

1. **Tipo de acción**:
   - Nulidad de testamento (defectos de forma, capacidad,
     consentimiento).
   - Petición de herencia (heredero preterido / mejor derecho).
   - Lesión de legítima.
   - Indignidad sucesoria (art. 756 CC y forales).
   - Reducción de donaciones inoficiosas.

2. **Plazos**:
   - Nulidad testamento: 15 años (art. 1301 CC) o 4 años si
     anulabilidad.
   - Petición herencia: 30 años (acción real).
   - Lesión legítima: 5 años desde aceptación.

3. **Foral-check**. Reglas distintas según ley sucesoria aplicable.

4. **`mcp__robin__preparar_escrito_sucesiones`** con tipo=impugnacion.

5. **Pruebas habituales**: pericial caligráfica, médica
...
- Pruebas de capacidad del testador: declaración del notario, pericial
  médica retrospectiva, doctrina sobre demencia senil.
- Indignidad: causas tasadas, no analogía.
