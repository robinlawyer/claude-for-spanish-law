---
name: sucesiones-testamento
description: >
  Redacción de testamento conforme ley aplicable. Formas (abierto, cerrado,
  ológrafo, mancomunado, pactos sucesorios donde se admitan).
argument-hint: "[testador + vecindad civil + bienes + voluntades]"
---

# /robin:sucesiones-testamento

Pipeline:

1. **Foral-check OBLIGATORIO**. Formas admitidas y libertad de testar
   varían radicalmente:
   - CC estatal: legítima 2/3, formas tradicionales.
   - Cataluña: pacto sucesorio (heretament) válido (art. 431 CCCat).
   - Aragón: testamento mancomunado, fiducia sucesoria, pacto
     sucesorio.
   - Navarra: libertad de testar amplísima, pactos sucesorios.
   - País Vasco: herencia troncal en zonas específicas.
   - Galicia: apartación, mejora pactada (LDCG arts. 209 ss).
   - Baleares: definición (renuncia anticipada a la legítima por
     pacto).

2. **`mcp__robin__preparar_escrito_sucesiones`** con tipo=testamento.

3. **Cláusulas tipo**:
   - Institución de herederos.
   - Legados.
   - Sustitución vulgar / fideicomisaria.
   - Designación albacea contador-partidor.
   - Cautelas de bujías (forales).
   - Cautela socini (mejora condicionada).

4. **Doctrina TS Sala 1ª**.

5. **Verifica citas**.

## Avisos típicos

- Testamento ológrafo: requisitos del art. 688 CC (manuscrito íntegro
  + firma + fecha completa).
- Cláusulas ineficaces: no afectan al resto si separables (favor
  testamenti).
- Cambio de vecindad civil tras testar: nueva ley aplica salvo
  conservación de la elegida en testamento (art. 9.8 CC + STS).
