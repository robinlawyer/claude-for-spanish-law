...
1. **Tipo de procedimiento**: gestión (limitada de revisión / abreviada
   / verificación de datos), inspección (actuaciones generales o
   parciales), comprobación e investigación.

2. **Plazo de alegaciones**:
   - Trámite de audiencia (10 días).
   - Acta firmada en disconformidad (15 días).
   - Otros: según norma.

3. **`mcp__robin__preparar_escrito_tributario`** con tipo=alegaciones.

4. **Líneas de defensa**:
   - Prescripción.
   - Caducidad del procedimiento.
   - Defectos formales (motivación insuficiente, falta de
     contradicción).
   - Improcedencia de la regularización (criterio jurídico de la
     Administración erróneo).
   - Atenuación de sanciones (ausencia culpabilidad, error invencible).

5. **Doctrina vinculante**:
   - **TEAC**: `mcp__robin__buscar_teac`. Vincula a la Administración.
   - **DGT**: `mcp__robin__buscar_dgt` consultas vinculantes.
