---
name: tributario-contencioso
description: >
  Recurso contencioso-administrativo en materia tributaria, tras agotar vía
  económico-administrativa.
argument-hint: "[resolución TEAC/TEAR + motivos + órgano competente]"
---

# /robin:tributario-contencioso

Pipeline:

1. **Plazo**: 2 meses desde notificación de la resolución TEAR/TEAC
   (o 6 meses si silencio).

2. **Competencia**: TSJ, AN o TS según órgano que dictó el acto y
   cuantía.

3. **`mcp__robin__preparar_recurso_administrativo`** con
   tipo=contencioso_tributario.

4. **Motivos**: todos los del contencioso administrativo + los
   tributarios específicos (regularización improcedente, calificación
   incorrecta, fraude de ley, simulación, etc.).

5. **Jurisprudencia Sala 3ª TS** y AN contencioso-tributario.

6. **Casación tributaria**: interés casacional objetivo (art. 88.2
   LJCA).
...
- TS Sala 3ª ha unificado criterio en muchas cuestiones controvertidas
  recientes. Comprobar última doctrina antes de redactar.
- Reformatio in peius prohibida en contencioso.
