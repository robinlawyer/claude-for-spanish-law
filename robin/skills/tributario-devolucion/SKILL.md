---
name: tributario-devolucion
description: >
  Solicitud de devolución de ingresos indebidos (arts. 31-34 LGT + RD 520/2005).
  Prescripción 4 años; intereses de demora.
argument-hint: "[ingreso indebido + fecha + motivo]"
---

# /robin:tributario-devolucion

Pipeline:

1. **Tipo de devolución**:
   - Ingresos indebidos (cobro indebido AEAT, error en autoliquidación,
     duplicidad, prescripción).
   - Devolución derivada de la normativa del tributo
     (compensaciones, pagos a cuenta excesivos).

2. **Plazo**: 4 años desde el ingreso indebido (prescripción art.
   66 LGT) o 4 años desde el día siguiente al de finalización del
   plazo de presentación de la autoliquidación.

3. **`mcp__robin__preparar_escrito_tributario`** con tipo=devolucion_indebidos.

4. **Intereses de demora**: `mcp__robin__calcular_intereses_demora`.

5. **Doctrina TEAC y TS** sobre dies a quo y cómputo.

6. **Verifica citas**.

## Avisos típicos

- Si la devolución deriva de doctrina TJUE sobre tributos contrarios
  al Derecho UE: plazos especiales.
- Compensación con otras deudas tributarias del contribuyente: posible.
