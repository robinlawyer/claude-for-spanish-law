---
name: tributario-inspeccion
description: >
  Asistencia durante procedimiento de inspección. Diligencias, requerimientos
  de información, derechos del contribuyente, actas en conformidad o
  disconformidad.
argument-hint: "[fase de inspección + objeto + posición del contribuyente]"
---

# /robin:tributario-inspeccion

Pipeline:

1. **Fase actual**: inicio (comunicación), desarrollo (diligencias),
   conclusión (acta).

2. **Derechos del contribuyente** (art. 34 LGT): conocer el objeto,
   ser representado por letrado, no aportar lo ya aportado, etc.

3. **Duración máxima** (art. 150 LGT): 18 meses general (27 meses
   en casos cualificados). Si se excede sin justificación: efectos
   sobre la interrupción de la prescripción.

4. **Tipos de actas**:
   - Conformidad: reducción del 30 % de sanciones.
   - Disconformidad: contradicción en alegaciones (15 días).
   - Con acuerdo (art. 155 LGT): reducción 50 % sanciones, pago en
     plazo.

5. **`mcp__robin__preparar_escrito_tributario`** con tipo=alegaciones_acta.

6. **Comportamiento estratégico**: distinguir entre aportar lo
   exigido y volunteer informaciones que extiendan el alcance de la
   inspección.

7. **Doctrina TEAC y TS** sobre defectos procedimentales.

8. **Verifica citas**.

## Avisos típicos

- Reanudación de actuaciones tras interrupción injustificada > 6
  meses: pérdida de efectos interruptivos de la prescripción
  (art. 150.6 LGT).
- Actas con acuerdo: irrecurribles salvo nulidad. Sopesar mucho.
