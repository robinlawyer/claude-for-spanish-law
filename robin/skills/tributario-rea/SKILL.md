...
name: tributario-rea
description: >
  Reclamación económico-administrativa ante TEAR o TEAC (LGT arts. 226-249).
  Vía gratuita previa al contencioso.
argument-hint: "[acto impugnado + cuantía + órgano (TEAR o TEAC)]"
---

# /robin:tributario-rea

Pipeline:

1. **Competencia**:
   - **TEAR** (regional): regla general.
   - **TEAC**: cuantía > 150.000 € (300.000 € en grupos), unificación
     de criterio, salto pactado.

2. **Plazo**: 1 mes desde notificación.

3. **Procedimiento**:
   - General.
   - Abreviado (cuantía ≤ 6.000 € o vicios específicos).
   - Per saltum (TEAC directo si cuantía).
   - Unificación de criterio / extraordinario de revisión.

4. **`mcp__robin__preparar_escrito_tributario`** con tipo=rea.

5. **Suspensión** (art. 233 LGT). Garantías según tipo de acto.

6. **Doctrina TEAC vinculante**. `mcp__robin__buscar_teac`.

7. **Plazos de resolución**: 1 año (general) / 6 meses (abreviado).
   Silencio negativo.
...
Escrito de interposición + alegaciones (puede unirse o presentar
después por separado).

## Avisos típicos

- TEAC vincula a la Administración tributaria (art. 239.7 LGT). Es
  literalmente doctrina.
- Plazo de resolución: si excede sin notificación, silencio negativo
  pero el plazo del contencioso empieza desde la fecha de silencio
  (no desde notificación posterior).
