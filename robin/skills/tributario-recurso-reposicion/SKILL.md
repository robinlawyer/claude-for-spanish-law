---
name: tributario-recurso-reposicion
description: >
  Recurso potestativo de reposición tributario (art. 222 LGT). Alternativo
  a REA. Plazo 1 mes.
argument-hint: "[acto impugnado + cuantía + motivos]"
---

# /robin:tributario-recurso-reposicion

Pipeline:

1. **Plazo**: 1 mes desde notificación del acto.

2. **`mcp__robin__preparar_escrito_tributario`** con tipo=reposicion.

3. **Motivos**: cualquier infracción del ordenamiento (procedimental
   o material).

4. **Suspensión**: sin garantías si cumple requisitos del art. 233
   LGT; con garantías en caso contrario.

5. **Doctrina TEAC y DGT** aplicable.

6. **Verifica citas**.

## Avisos típicos

- Renuncia a REA: si optas por reposición, la REA queda excluida
  hasta que se resuelva la reposición.
- Si se mantiene desestimación: cabe REA tras la reposición
  (acumulación).
